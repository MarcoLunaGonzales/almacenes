           ...
           <rich:panel headerClass="headerClassACliente">
               <center>
                   <h:panelGrid columns="4" >
                       ...
                       <h:outputText value="#{ManagedSolicitudSalidaAlmacen.salidasAlmacenDetalle.cantidadSalidaAlmacen}" styleClass="outputText2" id="cantTotalSalidaFisica" />
                       <h:outputText value="Item:" styleClass="outputText2" style="font-weight:bold"/>
                       <h:outputText value="#{ManagedSolicitudSalidaAlmacen.salidasAlmacenDetalle.materiales.nombreMaterial}" styleClass="outputText2" />
                   </h:panelGrid>
           ...
           <div align="center">
               <a4j:commandButton styleClass="btn" value="Registrar"
                                  ...
                                  oncomplete="if('#{facesContext.maximumSeverity}'.length == 0){
                                                if(#{ManagedSolicitudSalidaAlmacen.transaccionExitosa}){
