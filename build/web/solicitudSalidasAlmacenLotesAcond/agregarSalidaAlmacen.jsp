            ...
            <a4j:form id="form1">
                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.codLoteProduccion}" styleClass="outputText1" id="codLoteProduccion" >
                                <%--a4j:support event="onkeyup" action="#{ManagedRegistroSalidaAlmacen.nroLote_change}" reRender="codAreaEmpresa" onsubmit="if(document.getElementById('form1:codLoteProduccion').value.length>1){return false;}"
                                oncomplete="if(#{ManagedRegistroSalidaAlmacen.mensaje!=''}){alert('#{ManagedRegistroSalidaAlmacen.mensaje}');}" />
                            ...
                            <h:panelGroup id="producto">
                                <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.componentesProd.codCompprod}"   >
