...
<f:view>
    ...
    <html>
        ...
        <%-- onbeforedomupdate="alert('hola')" onLoad="window.defaultStatus='Hola, yo soy la barra de estado.';" onload="Richfaces.showModalPanel('panelTipoSalidaAlmacenProduccion');" --%>
        <body>
            ...
            <a4j:form id="form1" onreset="alert('hola')"  oncomplete="Richfaces.showModalPanel('panelTipoSalidaAlmacenProduccion');" >
                ...
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedSalidaAlmacenPorLoteAcond.cargarContenidoLotesProductosSemiterminados}"  />
                    ...
                    <br> <br>
                        ...
                        <rich:dataTable value="#{ManagedSalidaAlmacenPorLoteAcond.lotesProductosSemiterminadosList}" var="data" id="dataProgramaProduccion"
                        ...
                        <rich:column style="background-color: #{data.colorFila}">
                            ...
                            <h:outputText value="#{data.cantRestante}"  />
                        </rich:column >
                    </rich:dataTable>
                    </h:panelGroup>
                    </div>
                    ...
                    action="#{ManagedSalidaAlmacenPorLoteAcond.generarSalidaAlmacen_action}"
                     />
            ...
            <rich:modalPanel id="panelTipoSalidaAlmacenProduccion"  minHeight="150"  minWidth="400"
