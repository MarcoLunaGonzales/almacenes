package reportes.reporteMaterialesStock_1;
...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Stock de Materiales</h4>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Stock Minimo Material</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Stock Maximo Material</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Existencia Aprobados</b></td>
                ...
                String consulta = " select um.ABREVIATURA,M.NOMBRE_MATERIAL,ISNULL(M.NOMBRE_COMERCIAL_MATERIAL,'') AS MCM ," +
                                  ...
                                  " ISNULL(M.CANTIDAD_MINIMAMUESTREO,0) AS CMIN,ISNULL(M.CANTIDAD_MAXIMAMUESTREO,0) AS CMAX,m.stock_maximo_material,m.stock_minimo_material," +
                                  " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade, ingresos_almacen_detalle iad," +
                                  " ingresos_almacen ia WHERE iade.cod_material = m.cod_material and ia.cod_estado_ingreso_almacen = 1" +
                                  ...
                                  " and ia.cod_almacen = 1 and ia.fecha_ingreso_almacen <= '"+sdf.format(new Date())+" 23:59:59' and iade.cod_estado_material in (2, 6 , 8)" +
                                  " and iade.cantidad_restante > 0) as aprobados"+
                ...
                String estilo = "style='background-color:#F5A9A9'";
                while (res.next()) {
                   
                                out.print("<tr "+(res.getDouble("aprobados")<res.getDouble("stock_minimo_material")?estilo:"")+">");
                                ...
                                out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;' class='border'   >"+formato.format(res.getDouble("stock_minimo_material"))+"</td>");
                                out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;' class='border'   >"+formato.format(res.getDouble("stock_maximo_material"))+"</td>");
                                out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;' class='border'   >"+formato.format(res.getDouble("aprobados"))+"</td>");
                                out.print("</tr>");
