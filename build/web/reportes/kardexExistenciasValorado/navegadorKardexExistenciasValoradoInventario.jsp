...
<f:view>
    ...
    function datosForm(){
        ...
        document.getElementById("form1:nombreAlmacen").value = document.getElementById('form1:codAlmacen').options[document.getElementById('form1:codAlmacen').selectedIndex].innerHTML;
        //alert("el valor"+document.getElementById('form1:codAlmacen').options[document.getElementById('form1:codAlmacen').selectedIndex].value);
    }
       </script>
        </head>
        <body >
            <a4j:form id="form1" target="_blank" >
                <div align="center">
                    ...
                    <h:outputText styleClass="outputTextTitulo"  value="KARDEX DE MOVIMIENTO VALORADO" />
                    <br><br>
                     ...
                     <h:panelGrid columns="6" >                        
                                    ...
                                    <h:inputHidden value="#{ManagedActualizacionCostos.almacenes.nombreAlmacen}" id="nombreAlmacen" />
                                    </h:panelGroup>
                   ...
                   <div align="center">
                       <a4j:commandButton value="Ver Reporte"  styleClass="btn" onclick="datosForm();"
                    action="#{ManagedActualizacionCostos.generarActualizacionInventarios_action}"
                    reRender="panelContenidoActualizacion"
                    oncomplete = "enviarForm(form1)" /><a4j:commandButton value="Ver Reporte Resumido"  styleClass="btn" onclick="datosForm();"
                    action="#{ManagedActualizacionCostos.generarActualizacionInventarios_action}"
                    reRender="panelContenidoActualizacion"
                    oncomplete = "form1.action='reporteKardexExistenciasValoradoResumido.jsp';form1.submit();" /><br/>
