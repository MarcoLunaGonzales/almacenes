        ...
        try {
	        ...
	        <thead>
                ...
                String consulta = " select * from ( " +
                        ...
                        " and ia.cod_tipo_ingreso_almacen=tia.cod_tipo_ingreso_almacen and iad.cod_material IN (" + cod_mate + ") and ia.cod_almacen=" + codAlmacen + " and ia.fecha_ingreso_almacen>='" + fechaInicial + " 00:00:00'  " +
                        ...
                        " and sa.cod_tipo_salida_almacen=tsa.cod_tipo_salida_almacen and sa.cod_area_empresa = ae.cod_area_empresa and sad.cod_material IN (" + cod_mate + ") and sa.cod_almacen=" + codAlmacen + " and sa.fecha_salida_almacen>='" + fechaInicial + " 00:00:00'  " +
                ...
                while (rs.next()) {
                    ...
                    out.print("<td height='30px' class='border' align='left'  style='border-left : solid #D8D8D8 1px;border-bottom: solid #D8D8D8 1px;padding: 5px;' colspan=6></td>");
