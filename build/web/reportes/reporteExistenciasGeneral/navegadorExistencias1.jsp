...
<html>
        ...
        <script type="text/javascript" >
          function ajaxAlmacen(f){
             ...
             function buscarMaterial(f){
                ...
                ajax.open("GET","../ajaxMaterial.jsf?codCapitulo="+arrayCodCapitulo+"&codGrupo="+arrayCodGrupo+"&nombreMaterial="+encodeURIComponent(nombreMaterial)+"&movimientoItem="+movimiento+
                                "&codEstadoRegistro="+f.codEstadoItem.value+"&date="+(new Date()).getTime().toString(),true);
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
            ...
            function verReporte(f,nombreReporte){
                ...
                f.conExistenciasAlmacen.value=(f.checkExistenciaReactivo.checked?1:0);
    ...
    <body>
        <h3 align="center">REPORTE DE EXISTENCIAS GENERAL</h3>
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                        ...
                        <td style="padding:8px" style="padding:8px" colspan="3" >
                            <input type="text" class="inputText" size="70" name="nombreMaterial" id="nombreMaterial" />
                        </td>
                    ...
                    <tr class="outputText3">
                        ...
                        <td style="padding:8px" style="padding:8px">::</td>
                        <td style="padding:8px" style="padding:8px">
                            <select name="movimiento" id="movimiento" class="outputText3">
                        ...
                        <td style="padding:8px" style="padding:8px">Estado Item</td>
                        <td style="padding:8px" style="padding:8px">::</td>
                        <td style="padding:8px" style="padding:8px">
                            <select name="codEstadoItem" class="outputText3">
                        ...
                        <tr class="outputText3">
                            <td style="padding:8px" style="padding:8px">Existencia <br>(Almacen Reactivos)</td>
                            <td style="padding:8px" style="padding:8px">::</td>
                            <td style="padding:8px" style="padding:8px">
                            <input type="checkbox" name="checkExistenciaReactivo"/>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                <input type="button" class="btn"  value="Ver Reportes" name="reporte" onclick="verReporte(form1,'reporteExistenciasAlmacen.jsp')" />
                            </td>
                            <td colspan="9">
                                <input type="button" class="btn"  value="Ver nuevo" name="reporte2" onclick="verReporte(form1,'navegadorExistenciasValoradoN.jsp')" />
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <input type="hidden" name="conExistenciasAlmacen"/>
