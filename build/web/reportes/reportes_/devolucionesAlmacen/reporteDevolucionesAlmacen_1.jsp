package reportes.devolucionesAlmacen;
    ...
    <body>
        ...
        <form target="_blank" id="form" name="form">
            ...
            <table  align="center" width="90%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                <%
                try{
                   String codAlmacen2=String.valueOf(ingresosAlmacen.getAlmacenes().getCodAlmacen());
               ...
               // con = Util.openConnection(con);
                ...
                consulta = "  select  ISNULL(SUM(dde.CANTIDAD_DEVUELTA),0) as cantBuenas,ISNULL(SUM(dde.CANTIDAD_FALLADOS),0) as cantFallados,ISNULL(SUM(dde.CANTIDAD_FALLADOS_PROVEEDOR),0) as cantFallProv "+
                    ...
                    "inner join materiales m on m.COD_MATERIAL = dd.COD_MATERIAL inner join UNIDADES_MEDIDA u on u.COD_UNIDAD_MEDIDA = dd.COD_UNIDAD_MEDIDA where dd.COD_DEVOLUCION = '"+ingresosAlmacen.getDevoluciones().getCodDevolucion()+"' "+
