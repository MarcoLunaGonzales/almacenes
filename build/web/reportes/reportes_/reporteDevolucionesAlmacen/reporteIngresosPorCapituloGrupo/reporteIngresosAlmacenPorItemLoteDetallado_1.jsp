        ...
        <form>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Etiqueta</b></td>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " ,iade.LOTE_MATERIAL_PROVEEDOR,iade.ETIQUETA " +
                        ...
                        consulta = consulta + " order by ia.FECHA_INGRESO_ALMACEN desc,m.NOMBRE_MATERIAL,iade.ETIQUETA ";
                ...
                while (rs.next()) {
                    ...
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(rs.getString("ETIQUETA"))+"</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(rs.getString("LOTE_MATERIAL_PROVEEDOR"))+"</td>");
