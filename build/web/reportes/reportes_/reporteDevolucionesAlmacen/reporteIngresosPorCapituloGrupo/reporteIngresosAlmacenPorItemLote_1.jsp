...
package reportes.reporteIngresosAlmacen.reporteIngresosAlmacenPorItem_1;
...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos Por Lote</h4>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        //" ,(select top 1 i.LOTE_MATERIAL_PROVEEDOR from INGRESOS_ALMACEN_DETALLE_ESTADO i where   i.COD_INGRESO_ALMACEN=ia.COD_INGRESO_ALMACEN and i.COD_MATERIAL=m.COD_MATERIAL and iad.COD_INGRESO_ALMACEN=i.COD_INGRESO_ALMACEN and iad.COD_MATERIAL=i.COD_MATERIAL and iad.COD_INGRESO_ALMACEN=ia.COD_INGRESO_ALMACEN) as lote " +
                        ...
                        //" inner join INGRESOS_ALMACEN_DETALLE_ESTADO iade on iade.COD_INGRESO_ALMACEN =ia.COD_INGRESO_ALMACEN " +
                ...
                costoTotal = 0;
                while (rs.next()) {
                    String sql="select DISTINCT i.LOTE_MATERIAL_PROVEEDOR from INGRESOS_ALMACEN_DETALLE_ESTADO i where i.COD_INGRESO_ALMACEN="+rs.getString("COD_INGRESO_ALMACEN")+" and i.COD_MATERIAL="+rs.getString("COD_MATERIAL")+"";
                    System.out.println("sql:"+sql);
                    Statement st1 = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                    ResultSet rs1 = st1.executeQuery(sql);
                    String codLote="";
                    if (rs1.next()){
                        codLote=rs1.getString(1);
                    }
                    ...
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+codLote+"</td>");
                    out.print("</tr>");
                    costoTotal = costoTotal + rs.getDouble("CANT_TOTAL_INGRESO_FISICO") ;
                  }
                                out.print("<tr>");
                                out.print("<td HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;' colspan = '10'  >TOTAL&nbsp;</td>");
