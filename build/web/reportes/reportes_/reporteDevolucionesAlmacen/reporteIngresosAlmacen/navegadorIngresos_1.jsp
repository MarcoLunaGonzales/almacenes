package reportes.reporteDevolucionesAlmacen.reporteIngresosAlmacen;

package reportes.reporteIngresosAlmacen_1.reporteIngresosAlmacen;
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                       ...
                       <tr class="outputText3">
                        ...
                        <td class="">::</td>
                        <td class="">
                                <input type="text" style="color:blue;text-transform:uppercase" onkeypress="valNum(event);" class="inputText" size="20" name="numIngreso" />
                        </td>
                    </tr>
                    ...
                    <tr class="outputText3">
                        ...
                        <td class="">::</td>
                        <td class="">
                                <input type="text" style="color:blue;text-transform:uppercase" onkeypress="valNum(event);" class="inputText" size="20" name="numOC" />
                        </td>
                   </tr>
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteIngresos.jsp')" />
