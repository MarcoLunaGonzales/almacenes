...
<html>
    ...
    <body>
        <br>
        <br>
        <h3 align="center">Reporte Devoluciones por Nro. de Lote</h3>
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
            <div align="center">
                <table border="0"  border="0" class="border" width="60%">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select style="color:blue"    name="codFilial" class="outputText3" onchange="ajaxAlmacen(form1);">
                                <%
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <input type="text"  size="12" style="color:blue"   value="<%=form.format(new Date()) %>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                           <td class="">
                             <input type="text"  size="12" style="color:blue"     value="<%=form.format(new Date()) %>" name="fecha2" class="inputText">
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteDevolucionesPorlote.jsp')" />
