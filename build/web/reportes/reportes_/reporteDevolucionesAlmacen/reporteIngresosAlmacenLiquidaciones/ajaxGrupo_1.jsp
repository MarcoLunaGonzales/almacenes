package reportes.reporteDevolucionesAlmacen.reporteIngresosAlmacenLiquidaciones;

package reportes.reporteIngresosAlmacen_1.reporteIngresosAlmacenLiquidaciones;
...
out.println("<select name='codGrupo' size='10' class='inputText' style='width:200px' multiple >");
while(rs.next()){
