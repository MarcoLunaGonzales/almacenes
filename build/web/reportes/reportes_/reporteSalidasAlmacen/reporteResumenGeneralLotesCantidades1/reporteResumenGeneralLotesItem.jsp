package reportes.reporteSalidasAlmacen.reporteResumenGeneralLotesCantidades1;
...
<html>
    ...
    <body>
        ...
        try {
            ...
            <table align="CENTER" width="100%" class="outputText2" cellpadding="0" cellspacing="0">
                <tr>
                    <td rowspan="3" width="200px" style="border-bottom:1px solid #cccccc;border-top:1px solid #cccccc" height="40PX"> <img src="../../../img/cofar.png" alt="logo cofar" align="left" /></td>
                    <th style="border-bottom:1px solid #cccccc;border-top:1px solid #cccccc;border-LEFT:1px solid #cccccc" height="40PX">ALMACEN DE PRIMA PRIMA</th>
                    <th style="border-bottom:1px solid #cccccc;border-top:1px solid #cccccc;border-LEFT:1px solid #cccccc">Página 1 de 1</th>
                </tr>
                <tr>
                    <th style="border-bottom:1px solid #cccccc;border-LEFT:1px solid #cccccc" height="40PX">AMP - IN 007/R01</th>
                    <th style="border-bottom:1px solid #cccccc;border-LEFT:1px solid #cccccc">Vigencia : 01/12/08</th>
                </tr>
                <tr>
                    <th style="border-bottom:1px solid #cccccc;border-LEFT:1px solid #cccccc" height="40PX">PROCEDIMIENTO DE DESPACHO <BR> MATERIA PRIMA Y EMPAQUE PRIMARIO</th>
                    <th style="border-bottom:1px solid #cccccc;border-LEFT:1px solid #cccccc">Página 1 de 1</th>
                </tr>
            </table>
            ...
            <BR>
                ...
                <tr>
                    <td>
                        ...
                        <table border="0" class="outputText1" align="CENTER" >
                            <tbody>
                  ...
                  <h4 align="center">REPORTE RESUMEN GENERAL DE LOTES POR ITEM</h4>
            <BR>

            <table width="100%" align="center" class="outputText0" style="border : solid #484848 1px;" cellpadding="0" cellspacing="0" >




                <tr style="text-transform:uppercase">
                    <td HEIGHT='35px'  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;" bgcolor="#f2f2f2"  align="center"><b>Item</b></td>
                    <td   style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;" bgcolor="#f2f2f2"  align="center"><b>Nro Lote</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"    bgcolor="#f2f2f2"  align="center"><b>Producto</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Salidas MP</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Salidas EP</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Entregada</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Teorica</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Fisica</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Diferencia</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Observaciones</b></td>
                    <td  style="border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;"   bgcolor="#f2f2f2"  align="center"><b>Cantidad <br> Lote del Proveedor</b></td>
                ...
                while (rs_lote.next()) {
                    ...
                    sql_cantidad += " where sa.COD_LOTE_PRODUCCION='"+codLoteProduccion+"' and sa.cod_salida_almacen=sad.cod_salida_almacen and sad.cod_material="+codaMterial+" and";
                    if (!fechaInicial.equals("") && !fechaFinal.equals("")) {
                         sql_cantidad += "  sa.FECHA_SALIDA_ALMACEN between '" + fechaInicial + " 00:00:00' and '" + fechaFinal + " 23:59:59'  ";
                    }
                    ...
                    out.print("<td height='50px' style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + nombreMaterial + "</td>");
                    ...
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + nombreProd + "<br><br><b> Totales</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + formato.format(salMP) + "<br><br><b> " + formato.format(salMP) + "</td>");
                    ...
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + formato.format(salEP) + "<br><br><b> " + formato.format(salEP) + "</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >&nbsp;</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >&nbsp;</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >&nbsp;</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >&nbsp;</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >&nbsp;</td>");
                   ...
                   // out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + formato.format(salVA) + "</td>");
                    out.print("<td style='border-bottom: solid #cccccc 1px;border-left:solid #cccccc 1px;;padding:5PX;' class='border'   >" + lotes_proveedores + "</td>");
