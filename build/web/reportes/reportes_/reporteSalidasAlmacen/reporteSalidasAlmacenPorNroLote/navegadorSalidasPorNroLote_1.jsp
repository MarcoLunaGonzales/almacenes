        ...
        f.nombreAreaEmpresaP.value=arrayNombreAreaEmpresa;
            ...
            function verReporte(f,nombreReporte){
                ...
                if(f.check.checked==false){
                    f.fechaReporte1.value=null;
                    f.fechaReporte2.value=null;
                }else{
    ...
    <body>
        ...
        SimpleDateFormat form = new SimpleDateFormat("dd/MM/yyyy");
                        ...
                        <td class="">
                            ...
                            <input type="text" disabled="true"  size="12" style="color:blue"   value="<%=form.format(new Date())%>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                        <td class="">
                            <input type="text" disabled="true"  size="12" style="color:blue"     value="<%=form.format(new Date())%>" name="fecha2" class="inputText">
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteSalidasPorNroLote.jsp')" />
