        ...
        <form target="_blank" id="form" name="form">
            ...
            <thead>
                <tr >
                    ...
                    <td  align="center" rowspan="2"><b>Cantidad</b></td>
                ...
                while (rs.next()){                    
                    ...
                    consulta="select iade.LOTE_MATERIAL_PROVEEDOR,sum(iade.CANTIDAD_RESTANTE) AS cantidadRestante"+
                             " from INGRESOS_ALMACEN ia inner join INGRESOS_ALMACEN_DETALLE_ESTADO iade on "+
                             " ia.COD_INGRESO_ALMACEN=iade.COD_INGRESO_ALMACEN"+
                             " where iade.COD_MATERIAL='"+rs.getInt("cod_material")+"' and ia.COD_ALMACEN='"+codAlmacen+"'"+
                             " and iade.CANTIDAD_RESTANTE>0.1" +
                             " and ia.COD_ESTADO_INGRESO_ALMACEN<>2"+
                             " and iade.COD_ESTADO_MATERIAL in (2,6,8)"+
                             "  group by iade.LOTE_MATERIAL_PROVEEDOR"+
                             " order by iade.LOTE_MATERIAL_PROVEEDOR";
