...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos Con Costo Promedio</h4>
            ...
            <table width="80%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Nro Salida Traspaso</b></td>
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>C. Unit</b></td>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " ISNULL(p.NOMBRE_PROVEEDOR,'') AS NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_PROMEDIO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO,u.NOMBRE_UNIDAD_MEDIDA,sa.nro_salida_almacen " +
                        ...
                        " left join traspaso_ingreso tri on ia.cod_ingreso_almacen=tri.cod_ingreso_almacen"+
                        " left join salidas_almacen sa on tri.cod_salida_almacen=sa.cod_salida_almacen"+
                        ...
                        consulta = consulta + " order by ia.NRO_INGRESO_ALMACEN desc ";
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<tr>");
                                out.print("<td class='border' align='right'  style='border : solid #D8D8D8 1px' >"+(rs.getString("NRO_INGRESO_ALMACEN")==null?"":rs.getString("NRO_INGRESO_ALMACEN"))+"</td>");
                                out.print("<td  class='border' style='border : solid #D8D8D8 1px'  align='right'  >"+format.format( rs.getDate("FECHA_INGRESO_ALMACEN")) +" &nbsp; "+ format1.format( rs.getTimestamp("FECHA_INGRESO_ALMACEN").getTime()) +"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px' class='border'   >"+(rs.getString("NRO_ORDEN_COMPRA")==null?"":rs.getString("NRO_ORDEN_COMPRA"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px' class='border'   >"+(rs.getString("NRO_SALIDA_ALMACEN")==null?"":rs.getString("NRO_SALIDA_ALMACEN"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px' class='border'   >"+(rs.getString("NOMBRE_TIPO_INGRESO_ALMACEN")==null?"":rs.getString("NOMBRE_TIPO_INGRESO_ALMACEN"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px' class='border'   >"+(rs.getString("NOMBRE_PROVEEDOR")==null?"":rs.getString("NOMBRE_PROVEEDOR"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(rs.getString("NOMBRE_MATERIAL")==null?"":rs.getString("NOMBRE_MATERIAL"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(rs.getString("NOMBRE_CAPITULO")==null?"":rs.getString("NOMBRE_CAPITULO"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(rs.getString("NOMBRE_GRUPO")==null?"":rs.getString("NOMBRE_GRUPO"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(rs.getString("NOMBRE_UNIDAD_MEDIDA")==null?"":rs.getString("NOMBRE_UNIDAD_MEDIDA"))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format(rs.getDouble("CANT_TOTAL_INGRESO_FISICO")))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format( rs.getDouble("COSTO_PROMEDIO")))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format( rs.getDouble("COSTO_PROMEDIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO")))+"</td>");
                                out.print("</tr>");
                                costoTotal = costoTotal + rs.getDouble("COSTO_PROMEDIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO");
                  }
                                out.print("<tr>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px' colspan = '11'  ></td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format(costoTotal))+"</td>");
                                out.print("</tr>");
