    ...
    <body>
        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                consulta = consulta + " inner join proveedores p on p.COD_PROVEEDOR=ia.COD_PROVEEDOR";
               ...
               /* if (!fechaInicial.equals("") && !fechaFinal.equals("")) {
                ...
                consulta = consulta + " GROUP BY iad.cod_material, ia.COD_PROVEEDOR,iade.LOTE_MATERIAL_PROVEEDOR,iade.FECHA_VENCIMIENTO, iade.COD_ESTADO_MATERIAL,p.NOMBRE_PROVEEDOR,e.NOMBRE_ESTADO_MATERIAL,m.NOMBRE_MATERIAL order by m.NOMBRE_MATERIAL asc";
                ...
                while (rs.next()) {
                    ...
                    if(rs.getInt("cod_material")!=cod_material_ant){
                        ...
                        out.print("<tr>");
                            ...
                            out.print("<td class='border' style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + sdfMMyyyy.format(rs.getDate("FECHA_VENCIMIENTO"))+ "</td>");
