                ...
                ResultSet rs = st.executeQuery(sql);
                        ...
                        <tr class="outputText3">
                            ...
                            %>
                                ...
                                <select id="codTipoIngresoAlmacen" name="codTipoIngresoAlmacen"  multiple class="outputText3" >
                        ...
                        <tr class="outputText3">
                            ...
                            <td  height="35px" class="">Persona que Genera el ingreso</td>
                            <td class="">::</td>
                            <td>
                                <select class="inputText" id="codPersonalGenera" name="codPersonalGenera">
                                    <option value="0">--TODOS--</option>
                                <%
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                ...
                                <input type="button" class="btn"  value="Reporte Por Item Personalizado" name="reporteP" onclick="verReporte(form1,'reporteIngresosPersonalizado.jsp')" />
