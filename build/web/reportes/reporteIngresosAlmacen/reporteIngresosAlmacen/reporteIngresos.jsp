    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos </h4>
                    ...
                    try {
                    Connection con = null;
                    int codPersonalGenera = Integer.valueOf(request.getParameter("codPersonalGenera"));
                    System.out.println("codPersonalGenera"+codPersonalGenera);
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Obs.</b></td>
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Lote Material</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Cantidad</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Costo<br>Unitario</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Importe<br>Total</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Persona que genera el ingreso</b></td>
                    <%=((codTipoIngresoAlmacen.equals("")||codTipoIngresoAlmacen.contains("6"))?"<td  style='border : solid #D8D8D8 1px' class='border'  bgcolor='#f2f2f2'  align='center'><b>Lote de Devoluci�n</b></td>":"")%>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " p.NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_UNITARIO_ACTUALIZADO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO,u.ABREVIATURA " +
                        (codTipoIngresoAlmacen.equals("")||codTipoIngresoAlmacen.contains("6")?",isnull(sa.COD_LOTE_PRODUCCION,'') as COD_LOTE_PRODUCCION":"")+
                        ",iad.COSTO_UNITARIO_ACTUALIZADO,ia.OBS_INGRESO_ALMACEN,"+
                        " STUFF((select ', '+iade.LOTE_MATERIAL_PROVEEDOR"+
                                " from INGRESOS_ALMACEN_DETALLE_ESTADO iade "+
                                " where iade.COD_INGRESO_ALMACEN=iad.COD_INGRESO_ALMACEN"+
                                " and iade.COD_MATERIAL = iad.COD_MATERIAL FOR XML PATH('')"+
                        " ),1,1,'') as loteMaterial"+
                        ...
                        (codTipoIngresoAlmacen.equals("")||codTipoIngresoAlmacen.contains("6")?
                        " left outer join DEVOLUCIONES d on d.COD_DEVOLUCION=ia.COD_DEVOLUCION"+
                        " left outer join SALIDAS_ALMACEN sa on sa.COD_SALIDA_ALMACEN=d.COD_SALIDA_ALMACEN":"")+
                        ...
                        if(codPersonalGenera > 0){
                            consulta+=" and ia.COD_PERSONAL="+codPersonalGenera;
                        }
                        if(!numOCP.equals("") ){
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;' class='border'   >"+(rs.getString("OBS_INGRESO_ALMACEN")==null?"":rs.getString("OBS_INGRESO_ALMACEN"))+"</td>");
                                ...
                                out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+(rs.getString("loteMaterial")==null?"":rs.getString("loteMaterial"))+"</td>");
                                ...
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("COSTO_UNITARIO_ACTUALIZADO")))+"</td>");
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("CANT_TOTAL_INGRESO_FISICO")*rs.getDouble("COSTO_UNITARIO_ACTUALIZADO")))+"</td>");
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+rs.getString("nombrePersonal")+"</td>");
                                
                                if(codTipoIngresoAlmacen.equals("")||codTipoIngresoAlmacen.contains("6"))out.println("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+rs.getString("COD_LOTE_PRODUCCION")+"&nbsp;</td>");
                                out.print("</tr>");
