        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Lote - Fecha Vencimiento</b></td>
                ...
                while (rs.next()) {
                    ...
                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >");
                    consulta = " select distinct iade.fecha_vencimiento,iade.LOTE_MATERIAL_PROVEEDOR from INGRESOS_ALMACEN_DETALLE_ESTADO iade where iade.COD_INGRESO_ALMACEN = '"+rs.getInt("COD_INGRESO_ALMACEN")+"' and iade.COD_MATERIAL = '"+rs.getInt("COD_MATERIAL")+"' ";
                    Statement st1 = con.createStatement();
                    ResultSet rs1 = st1.executeQuery(consulta);
                    out.print("<table width='100%' style='align=left'>");
                    while(rs1.next()){
                        out.print("<tr><td style='width:50%'>"+(rs1.getString("lote_material_proveedor")!=null?rs1.getString("lote_material_proveedor").trim():" ")+"&nbsp;</td><td style='width:50%'>"+sdfMMyyyy.format(rs1.getDate("fecha_vencimiento"))+"&nbsp;</td></tr>");
                    }
                    out.print("</table></td>");
                    //+ (rs.getString("ABREVIATURA") == null ? "" : rs.getString("ABREVIATURA")) + "</td>");
                    out.print("</tr>");
