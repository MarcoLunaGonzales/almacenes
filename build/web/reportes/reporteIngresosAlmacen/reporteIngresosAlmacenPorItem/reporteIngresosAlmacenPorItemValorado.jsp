        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Costo Unitario</b></td>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " p.NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_UNITARIO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO,u.ABREVIATURA,iad.COSTO_UNITARIO*iad.CANT_TOTAL_INGRESO_FISICO costo_total " +
                ...
                while (rs.next()) {
                    ...
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato1.format(rs.getDouble("COSTO_UNITARIO"))) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("costo_total"))) + "</td>");
                    out.print("</tr>");
                ...
                out.print("<td></td><td></td><td style='border : solid #D8D8D8 1px;padding-left:5PX;'>"+formato.format(costoTotal1)+"</td>");
                out.print("</tr>");
