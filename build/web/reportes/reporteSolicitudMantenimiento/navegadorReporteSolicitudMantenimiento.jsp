...
<html>
  ...
  <td align="center" >
    ...
    <table  align="center" width="60%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
      ...
      <tr class="tablaFiltroReporte">
        ...
        <td  align="center" class="bordeNegroTd" ><%=rs.getString("NOMBRE_TIPO_SOLICITUD")%></td>
      </tr>
      ...
      <tr class="tablaFiltroReporte">        
        ...
        <td  align="center" class="bordeNegroTd" ><%=sdf1.format(rs.getTimestamp("FECHA_CAMBIO_ESTADOSOLICITUD"))%></td>
      </tr>
      <tr class="tablaFiltroReporte">
  ...
  consulta = " select s.COD_SOLICITUD_MANTENIMIENTO,t.COD_TIPO_TAREA,t.NOMBRE_TIPO_TAREA, s.COD_PERSONAL, " +
          ...
          "s.HORAS_HOMBRE  from SOLICITUDES_MANTENIMIENTO_DETALLE_TAREAS s    " +
  ...
  while (rs1.next()){
    ...
    String nombreProveedor = rs1.getString("NOMBRE_PROVEEDOR")==null?"":rs1.getString("NOMBRE_PROVEEDOR");
...
<br/>
  ...
  <tr class="tablaFiltroReporte" >
    <td  align="center" class="bordeNegroTd" width="20%" height="15%"><br/><br/><br/><br/><br/><br/><br/><br/></td>
  </tr>
   </table>
<br/>
    <table align="center" width="60%" class='outputText0'>
