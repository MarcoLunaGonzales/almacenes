        ...
        <form>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Obs.</b></td>
                ...
                consulta += " (select top 1  sss.COSTO_SALIDA_ACTUALIZADO from SALIDAS_ALMACEN_DETALLE_INGRESO sss where sss.COD_SALIDA_ALMACEN=sa.COD_SALIDA_ALMACEN and sss.COD_MATERIAL=sad.COD_MATERIAL and sss.CANTIDAD>0) as costo,sa.OBS_SALIDA_ALMACEN";
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<th ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(rs.getString("OBS_SALIDA_ALMACEN"))+"</th>");
                                ...
                                out.print("<tr>");
                                out.print("<td HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;' colspan = '8'  >TOTAL&nbsp;</td>");
