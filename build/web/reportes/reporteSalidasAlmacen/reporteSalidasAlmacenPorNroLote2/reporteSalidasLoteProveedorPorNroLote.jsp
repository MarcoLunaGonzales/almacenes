                ...
                while (rs.next()) {
                    if(c==0){
                        ...
                        if(nroSalidaAux!=rs.getInt("NRO_SALIDA_ALMACEN")){
                                ...
                                out.print("<td style = 'width:300px;vertical-align:top' >");
                                consulta = " select i.LOTE_MATERIAL_PROVEEDOR,s.CANTIDAD" +
                                        ...
                                        " inner jooin ingresos_almacen_detalle iad on iad.cod_ingreso_almacen = i.cod_ingreso_almacen and iad.cod_material = i.cod_material" +
                                        " inner join ingresos_almacen ia on ia.cod_ingreso_almacen = iad.cod_ingreso_almacen" +
                                        " inner join proveedores p on p.cod_proveedores = ia.cod_proveedor " +
                                        ...
                                        while(rs1.next()){
                                            ...
                                            out.print("<tr>");
                                            out.print("<td style='width:50%;border : solid #D8D8D8 1px;padding-left:5PX;'>"+(rs1.getString("nombre_proveedor")==null?"":rs1.getString("nombre_proveedor"))+"</td>");
                                            out.print("<td style='width:50%;border : solid #D8D8D8 1px;padding-left:5PX;'>"+(rs1.getString("lote_material_proveedor")==null?"":rs1.getString("lote_material_proveedor"))+"</td>");
                                            out.print("<td style='width:50%;border : solid #D8D8D8 1px;padding-left:5PX;'>"+rs1.getDouble("cantidad")+" "+(rs.getString("ABREVIATURA")==null?"":rs.getString("ABREVIATURA"))+"</td>");
                                            out.print("</tr>");
                                            }
                                        }
                                        out.print("</table>");
