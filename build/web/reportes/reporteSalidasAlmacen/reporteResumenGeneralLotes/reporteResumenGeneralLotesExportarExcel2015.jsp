    ...
    <body>
        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                sql_lote += " and ia.cod_estado_ingreso_almacen=1 and d.cod_estado_devolucion=1 and sa.COD_TIPO_SALIDA_ALMACEN in("+tiposSalidaReporte+") and cp.COD_COMPPROD=sa.COD_PROD";
