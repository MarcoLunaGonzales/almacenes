...
System.out.println(realpathX);%>
    ...
    <body bgcolor="#FFFFFF" text="#000000" >
        ...
        <form method="post" action="navegadorCargarLotesExcel.jsf" name="upform" enctype="multipart/form-data">
            <div align="center">
            <b>REPORTE SALIDAS,DEVOLUCIONES E INGRESOS APT POR NRO. DE LOTE A PARTIR DE EXCEL</b>
            <br>
        ...
        try {
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select style="color:blue" id="codFilial" name="codFilial" class="outputText3" onchange="ajaxAlmacen(upform);">
                                <%
        ...
        try {
            ...
            e.printStackTrace();
                    ...
                    <tr class="outputText3">
                        ...
                        <td colspan="5" class=""><input type="checkbox" id="check" name="check" <%=check%>  onclick="click1(this.form)"></td>
                    </tr>
                    ...
                    <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <input type="text" <%=(check.equals(""))?"disabled='true'":""%>  size="12" style="color:blue"   value="<%=fechaInicio%>" id="fecha1" name="fecha1"  class="inputText">
                        ...
                        <td class="">::</td>
                        <td class="">
                            <input type="text"   size="12" style="color:blue" <%=(check.equals(""))?"disabled='true'":""%>    value="<%=fechaFinal%>" id="fecha2" name="fecha2" class="inputText">
