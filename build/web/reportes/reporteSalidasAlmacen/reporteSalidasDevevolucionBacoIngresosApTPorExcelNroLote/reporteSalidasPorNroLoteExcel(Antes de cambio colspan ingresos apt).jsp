           ...
           */
           ...
           fechaFinalFormato=arrayFecha[2]+"/"+arrayFecha[1]+"/"+arrayFecha[0];
            ...
            <table width="90%" align="center" class="outputText0 tablaReporte" cellpadding="0" cellspacing="0" >
                ...
                <thead>
                <tr class="">
                    <td rowspan="2" HEIGHT='25PX'  ><b>Nro</b></td>
                    <td rowspan="2" HEIGHT='25PX'    align="center" ><b>Tipo Salida</b></td>
                    <td rowspan="2"    align="center" ><b>Fecha</b></td>
                    <td rowspan="2"    align="center"><b>Lote</b></td>
                    <td rowspan="2"    align="center"><b>Codigo Ant.</b></td>
                    <td rowspan="2"    align="center"><b>Item</b></td>
                    <td rowspan="2"    align="center"><b>Capitulo</b></td>
                    <td rowspan="2"    align="center"><b>Grupo</b></td>
                    <td rowspan="2"    align="center"><b>Unid.</b></td>
                    <td colspan="3"   align="center"><b>Salidas</b></td>
                    <td colspan="3"   align="center"><b>Devoluciones</b></td>
                    <td colspan="3"   align="center"><b>Totales</b></td>
                    <td rowspan="2"   align="center"><b>Producto</b></td>
                    <td rowspan="2"    align="center"><b>Codigo<br>Zeus</b></td>
                    <td rowspan="2"    align="center"><b>Presentacion</b></td>
                    <td colspan="5"    align="center"><b>Datos APT</b></td>
                </tr>
                <tr>
                    <td     align="center"><b>Cantidad</b></td>
                    <td     align="center"><b>Costo Unit.</b></td>
                    <td     align="center"><b>Costo Total</b></td>
                    <td     align="center"><b>Cantidad</b></td>
                    <td     align="center"><b>Costo Unit.</b></td>
                    <td     align="center"><b>Costo Total</b></td>
                    <td     align="center"><b>Cant. Neta</b></td>
                    <td     align="center"><b>Costo Unit. Neto</b></td>
                    <td     align="center"><b>Costo Neto</b></td>
                    <td     align="center"><b>Nro<br> Ingreso<br>Almacen</b></td>
                    <td     align="center"><b>Almacen</b></td>
                    <td     align="center"><b>Presentación</b></td>
                    <td     align="center"><b>Cantidad</b></td>
                    <td     align="center"><b>Cantidad<br>Unitaria</b></td>
                </tr>
                </thead>
                <tbody>
                <%
                ...
                for(String codLote:arrayLotes)
                {
                    ponerColor=true;
                        ...
                        salida+=" ISNULL(cp.nombre_prod_semiterminado,'') AS nombre_prod_semiterminado,isnull(pp.NOMBRE_PRODUCTO_PRESENTACION,'') as nombrePresentacion" +
                                ",pp.cod_presentacion";
                        ...
                        salida+=" left outer join COMPONENTES_PROD cp  on cp.COD_COMPPROD=sa.COD_PROD" +
                                 " left outer join PRESENTACIONES_PRODUCTO pp on pp.cod_presentacion=sa.COD_PRESENTACION";
                        ...
                        Statement stApt=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                        ResultSet resApt=null;
                        String innerHtmlApt="";
                        int c = 0;
                        int nroSalidaAux = 0;
                        String codigos="";
                        ...
                        while (rs.next()) {
                            ...
                            consultaApt="select iv1.NRO_INGRESOVENTAS,av.NOMBRE_ALMACEN_VENTA,pp1.NOMBRE_PRODUCTO_PRESENTACION,"+
                                        " idv1.CANTIDAD,idv1.CANTIDAD_UNITARIA"+
                                        " from INGRESOS_VENTAS iv1 inner join INGRESOS_DETALLEVENTAS idv1 on"+
                                        " iv1.COD_AREA_EMPRESA=idv1.COD_AREA_EMPRESA and "+
                                        " iv1.COD_INGRESOVENTAS=idv1.COD_INGRESOVENTAS"+
                                        " inner join PRESENTACIONES_PRODUCTO pp1 on pp1.cod_presentacion=idv1.COD_PRESENTACION"+
                                        " inner join ALMACENES_VENTAS av on av.COD_ALMACEN_VENTA=iv1.COD_ALMACEN_VENTA"+
                                        " where iv1.COD_ALMACEN_VENTA in (54,56,57) and idv1.COD_LOTE_PRODUCCION='"+rs.getString("COD_LOTE_PRODUCCION")+"'"+
                                        (rs.getInt("cod_presentacion") >0?" and idv1.COD_PRESENTACION='"+rs.getInt("cod_presentacion")+"'":"")+
                                        " order by av.NOMBRE_ALMACEN_VENTA,iv1.NRO_INGRESOVENTAS";
                            System.out.println("consulta ingresos apt "+consultaApt);
                            resApt=stApt.executeQuery(consultaApt);
                            innerHtmlApt="";
                            contFilasApt=0;
                            while(resApt.next())
                            {
                                innerHtmlApt+=(innerHtmlApt.equals("")?"":"<tr>")+
                                             "<td>"+resApt.getInt("NRO_INGRESOVENTAS")+"</td>"+
                                             "<td>"+resApt.getString("NOMBRE_ALMACEN_VENTA")+"</td>"+
                                             "<td>"+resApt.getString("NOMBRE_PRODUCTO_PRESENTACION")+"</td>" +
                                             "<td>"+formato.format(resApt.getDouble("CANTIDAD"))+"</td>"+
                                             "<td>"+formato.format(resApt.getDouble("CANTIDAD_UNITARIA"))+"</td></tr>";
                                contFilasApt=resApt.getRow();
                            }
                            
                            System.out.println("re "+contFilasApt);
                            if(innerHtmlApt.equals(""))innerHtmlApt="<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>";
                            out.print("<tr bgcolor='"+codColumna+"'>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   align='right'   >" + (rs.getString("NRO_SALIDA_ALMACEN") == null ? "" : rs.getString("NRO_SALIDA_ALMACEN")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >" + (rs.getString("NOMBRE_TIPO_SALIDA_ALMACEN") == null ? "" : rs.getString("NOMBRE_TIPO_SALIDA_ALMACEN")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'     >" + format.format(rs.getDate("FECHA_SALIDA_ALMACEN")) + " &nbsp; " + format1.format(rs.getTimestamp("FECHA_SALIDA_ALMACEN").getTime()) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'     >" + (rs.getString("COD_LOTE_PRODUCCION") == null ? "" : rs.getString("COD_LOTE_PRODUCCION")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'    >&nbsp;" + (rs.getString("CODIGO_ANTIGUO") == null ? "" : rs.getString("CODIGO_ANTIGUO")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  >" + (rs.getString("NOMBRE_MATERIAL") == null ? "" : rs.getString("NOMBRE_MATERIAL")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  >" + (rs.getString("NOMBRE_CAPITULO") == null ? "" : rs.getString("NOMBRE_CAPITULO")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  >" + (rs.getString("NOMBRE_GRUPO") == null ? "" : rs.getString("NOMBRE_GRUPO")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  >" + (rs.getString("ABREVIATURA") == null ? "" : rs.getString("ABREVIATURA")) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(rs.getDouble("cantidad_salida_almacen"))) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (redondear(rs.getDouble("costo_salida"), 4)) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(rs.getDouble("total_salida"))) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(cantDev)) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (redondear(costoUnitDev, 4)) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(costoTotalDev)) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(rs.getDouble("cantidad_salida_almacen")-cantDev)) + "</td>");
                            double costoUni=0d;
                            ...
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + redondear(costoUni,4) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(rs.getDouble("total_salida")-costoTotalDev)) + "</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   >" + rs.getString("nombre_prod_semiterminado") + "&nbsp;</td>");
                            
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   >" +(rs.getInt("cod_presentacion")>0?rs.getInt("cod_presentacion"):"")+ "&nbsp;</td>");
                            out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   >"+rs.getString("nombrePresentacion")+"&nbsp;</td>");

                            out.print(innerHtmlApt);
                        ...
                        if(conFecha)
                        {
                             String devoluciones = " select ISNULL((select top 1 cp.nombre_prod_semiterminado from COMPONENTES_PROD cp where cp.COD_COMPPROD=sa.COD_PROD),'') AS nombreProd,"+
                                                      " ISNULL((select top 1 cast(pp.cod_presentacion as varchar )+'&&&'+cast(pp.NOMBRE_PRODUCTO_PRESENTACION as varchar) from PRESENTACIONES_PRODUCTO pp where pp.cod_presentacion=sa.COD_PRESENTACION),' &&& ')as nombreProducto, d.cod_devolucion,sa.cod_salida_almacen,";
                                    devoluciones += " ia.fecha_ingreso_almacen,ia.cod_ingreso_almacen,";
                                    devoluciones += " iad.cod_material,";
                                    devoluciones += " isnull(iad.CANT_TOTAL_INGRESO_FISICO,0)as CANT_TOTAL_INGRESO_FISICO,";
                                    devoluciones += " isnull(iad.COSTO_UNITARIO_ACTUALIZADO,0)as COSTO_UNITARIO_ACTUALIZADO,";
                                    ...
                                    consultaApt="select iv1.NRO_INGRESOVENTAS,av.NOMBRE_ALMACEN_VENTA,pp1.NOMBRE_PRODUCTO_PRESENTACION,"+
                                        ...
                                        " inner join PRESENTACIONES_PRODUCTO pp1 on pp1.cod_presentacion=idv1.COD_PRESENTACION"+
                                        " inner join ALMACENES_VENTAS av on av.COD_ALMACEN_VENTA=iv1.COD_ALMACEN_VENTA"+
                                        " where iv1.COD_ALMACEN_VENTA in (54,56,57) and idv1.COD_LOTE_PRODUCCION='"+rs_devoluciones.getString("COD_LOTE_PRODUCCION")+"'"+
                                        (Integer.valueOf(presentacion[0]) >0?" and idv1.COD_PRESENTACION='"+presentacion[0]+"'":"")+
                                        " order by av.NOMBRE_ALMACEN_VENTA,iv1.NRO_INGRESOVENTAS";
                                    System.out.println("consulta ingresos apt "+consultaApt);
                                    resApt=stApt.executeQuery(consultaApt);
                                    innerHtmlApt="";
                                    ...
                                    out.print("<tr>");
                                    out.print("<td  rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("NRO_SALIDA_ALMACEN")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("NOMBRE_TIPO_SALIDA_ALMACEN")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+sdf2.format(rs_devoluciones.getTimestamp("FECHA_SALIDA_ALMACEN"))+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("COD_LOTE_PRODUCCION")+"</td>");


                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("CODIGO_ANTIGUO")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("NOMBRE_MATERIAL")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("NOMBRE_CAPITULO")+"</td>");
                                    out.print("<td  rowspan='"+(contFilasApt>0?contFilasApt:1)+"' align='right'   >"+rs_devoluciones.getString("NOMBRE_GRUPO")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("ABREVIATURA")+"</td>");
                                    out.print("<td  rowspan='"+(contFilasApt>0?contFilasApt:1)+"' align='right'   >0.00</td>");
                                    out.print("<td  rowspan='"+(contFilasApt>0?contFilasApt:1)+"' align='right'   >0.00</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >0.00</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (formato.format(cantDev)) + "</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"' ALIGN='RIGHT'   >" + (redondear(costoUnitDev, 4)) + "</td>");
                                    ...
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   align='right'   >"+redondear(costoUnitDev, 4)+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'   align='right'   >-"+formato.format(costoTotalDev)+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+rs_devoluciones.getString("nombreProd")+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+presentacion[0]+"</td>");
                                    out.print("<td rowspan='"+(contFilasApt>0?contFilasApt:1)+"'  align='right'   >"+presentacion[1]+"</td>");
            ...
            <td  align='right'  style='border-bottom : solid #D8D8D8 1px;border-left : solid #D8D8D8 1px;padding-left:5PX;font-family:monospace;font-size:x-large' >
