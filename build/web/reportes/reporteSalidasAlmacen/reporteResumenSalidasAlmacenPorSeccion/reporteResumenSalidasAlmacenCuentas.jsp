...
<html>
    ...
    <body>
        <form>
            <h4 align="center">RESUMEN DE SALIDAS DE ALMACEN POR CUENTA</h4>
        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                consulta += " (SELECT SUM(IAD.CANT_TOTAL_INGRESO_FISICO*IAD.COSTO_UNITARIO_ACTUALIZADO)";
                consulta += " FROM DEVOLUCIONES D,INGRESOS_ALMACEN IA,INGRESOS_ALMACEN_DETALLE IAD,";
                ...
                consulta += " AND D.ESTADO_SISTEMA = 1 AND IA.COD_ALMACEN = D.COD_ALMACEN ";
                if (!codTipoSalidaArray.equals("") && !codTipoSalidaArray.equals("0")) {
                    consulta += " AND SA.COD_TIPO_SALIDA_ALMACEN IN (" + codTipoSalidaArray + ") ";
                }
                if (!codAreaEmpresa.equals("") && !codAreaEmpresa.equals("0")) {
                ...
                consulta += " AND IA.COD_ESTADO_INGRESO_ALMACEN=1 ";
                consulta += " AND IA.COD_INGRESO_ALMACEN=IAD.COD_INGRESO_ALMACEN";
                ...
                consulta += " ) AS DEVOLUCIONES_CL," +
                        ...
                        consulta += " AND S.COD_ALMACEN in ("+codAlmacen+") AND D.COD_ALMACEN in ("+codAlmacen+")  AND IA.COD_ALMACEN in ("+codAlmacen+")";
                ...
                consulta += " FROM AREAS_EMPRESA AE,CUENTAS cu WHERE cu.COD_CUENTA=ae.COD_CUENTA and  AE.COD_ESTADO_REGISTRO=1";
