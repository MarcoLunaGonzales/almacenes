        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr bgcolor="#cccccc">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" colspan="2"><b><%=(fechaIni)%></b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" colspan="2"><b><%=(fechaFinal)%></b></td>
                </tr>
                <tr bgcolor="#cccccc">
                ...
                String consulta = " select m.cod_material, m.nombre_material,um.abreviatura,m.stock_minimo_material,m.stock_maximo_material," +
                                  ...
                                  " ,(select top 1 cmp.COSTO_MATERIAL from COSTOS_MATERIAL_POR_MES cmp where cmp.FECHA<='"+fechaIni+" 23:59:59' and cmp.COD_MATERIAL=m.COD_MATERIAL"+
                                  " and cmp.COD_ALMACEN="+codAlmacen+" order by cmp.FECHA desc ) as costoInicio"+
                                  " ,(select top 1 cmp1.COSTO_MATERIAL from COSTOS_MATERIAL_POR_MES cmp1 where cmp1.FECHA<='"+fechaFinal+" 23:59:59' and cmp1.COD_MATERIAL=m.COD_MATERIAL"+
                                  " and cmp1.COD_ALMACEN="+codAlmacen+" order by cmp1.FECHA desc ) as costoFinal"+
