...
<%
        ...
        parameters.put("SUBREPORT_DIR",a+File.separator+"reportes"+File.separator+"ordenesCompra"+File.separator);
        System.out.println("codOrdenCompra  1   "+codOrdenCompra);

      FileInputStream input=new FileInputStream (a+"/img/logo_cofar.png");

        /*
                    System.out.println("texto"+ literal[1]);
                    System.out.println("fechaEntrega"+ literal[2]);
                    System.out.println("bs"+ Double.parseDouble(literal[3]));
                    System.out.println("sus"+ Double.parseDouble(literal[4]));
                    System.out.println("aprobado1"+ literal[5]);
                    System.out.println("aprobado2"+ literal[6]);
                    System.out.println("aprobado3"+ literal[7]);
                    System.out.println("cargo1"+ literal[8]);
                    System.out.println("cargo2"+ literal[9]);
                    System.out.println("cargo3"+ literal[10]);
                    System.out.println("tipo_cambio"+ literal[11]);
                    System.out.println("cod_personal1"+ Integer.parseInt(literal[12]));
                    System.out.println("cod_personal2"+ Integer.parseInt(literal[13]));
                    System.out.println("cod_personal3"+ Integer.parseInt(literal[14]));
                    System.out.println("fecha1"+ literal[15]);
                    System.out.println("fecha2"+ literal[16]);
                    System.out.println("fecha3"+ literal[17]);
                    System.out.println("total_detalle"+ Double.parseDouble(literal[18]));
                    System.out.println("nulo"+ literal[19]);
                    System.out.println("sw_cargos_extra"+ Integer.parseInt(literal[20]));
                    System.out.println("titulo"+ literal[21]);
                    System.out.println("solicitante"+ literal[22]);
*/
