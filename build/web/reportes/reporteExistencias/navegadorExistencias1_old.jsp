           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3" >
                        ...
                        <td  style="padding:8px">
                            <div id="div_grupo">
                                <select multiple name="codGrupo" class="inputText" size="10" style="width:200px;" >
                    ...
                    <tr class="outputText3">
                        ...
                        <td style="padding:8px" style="padding:8px">
                            <input type="button" value="Buscar" class="outputText2" size="50" name="nombreMaterial" onclick="buscarMaterial(form1)" />
