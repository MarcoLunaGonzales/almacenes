...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Existencias para Inventario</h4>
                ...
                /*
                        ...
                        */
                        ...
                        String itemMovimiento=request.getParameter("movimiento")==null?"''":request.getParameter("movimiento");
            ...
            <table width="70%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center" ><b>Cod Material</b></td>
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Aprob. + Aprob. GI</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Total</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Enteros</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Saldos</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>(-)Tara</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Rec. Fisico</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Diferencia</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" width="20%"><b>Observacion</b></td>
                </tr>
                ...
                String consulta = " select m.cod_material,m.CODIGO_ANTIGUO,m.nombre_material,um.abreviatura,m.stock_minimo_material,m.stock_maximo_material,m.stock_seguridad, " +
                        ...
                        " and ia.cod_almacen="+codAlmacen+" and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cod_estado_material in( 2,6,8 ) and iade.cantidad_restante>0 )as aprobados, " +
                        ...
                        " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia " +
                        " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen " +
                        " and ia.cod_almacen="+codAlmacen+" and iade.cod_estado_material=1 and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cantidad_restante>0)as cuarentena, " +
                        " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia " +
                        " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen " +
                        " and ia.cod_almacen="+codAlmacen+" and iade.cod_estado_material=3 and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cantidad_restante>0)as rechazado, " +
                        " (select SUM(iade.cantidad_restante)  from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia " +
                        " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen " +
                        " and ia.cod_almacen="+codAlmacen+" and iade.cod_estado_material=4 and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cantidad_restante>0)as vencido, " +
                        " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia " +
                        " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen " +
                        " and ia.cod_almacen="+codAlmacen+" and iade.cod_estado_material=5 and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cantidad_restante>0)as obsoleto, " +
                        " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia " +
                        " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen " +
                        " and ia.cod_almacen="+codAlmacen+" and iade.cod_estado_material in(3,4,5) and ia.fecha_ingreso_almacen<='"+fecha+" 23:59:59' and iade.cantidad_restante>0)as observado " +
                        ...
                        consulta+=" and  m.movimiento_item="+itemMovimiento+" and m.cod_material in ("+codMaterial+") and m.cod_estado_registro=1 order by m.nombre_material,c.nombre_capitulo,g.nombre_grupo  ";
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                total = aprobados + rs.getDouble("cuarentena");
                                ...
                                if(sw==1){
                                out.print("<tr>");
                                out.print("<td class='border' align='right'  style='border : solid #D8D8D8 1px' >"+(rs.getString("cod_material")==null?"":rs.getString("cod_material"))+"</td>");
                                ...
                                out.print("<td  class='border' style='border : solid #D8D8D8 1px'  align='right'  >"+rs.getString("nombre_material")+"</td>");
                                ...
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+formato.format(total)+"</td>");
