        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                         ...
                         <rich:panel style="width:80%" headerClass="headerClassACliente">
                            <f:facet name="header">
                             ...
                             <h:panelGrid columns="6" >
                                            ...
                                            <h:panelGroup>
                                                <a4j:commandButton value="Cerrar Transacciones " action="#{ManagedActualizacionCostos.cerrarTransaccionesFecha_Action}"
                                                oncomplete="alert('#{ManagedActualizacionCostos.mensaje}')" styleClass="btn"/>
                                                <a4j:commandButton value="Abrir Transacciones " action="#{ManagedActualizacionCostos.abrirTransaccionesFecha_Action}"
                                                oncomplete="alert('#{ManagedActualizacionCostos.mensaje}')" styleClass="btn"/>
                                            </h:panelGroup>
                           </h:panelGrid>
                   ...
                   <a4j:commandButton value="Actualizar Costos"  styleClass="btn" onclick="iniciarProgressBar()"  action="#{ManagedActualizacionCostos.actualizarCostos_action}"
                    reRender="panelContenidoActualizacion" 
                    oncomplete = "if('#{ManagedActualizacionCostos.mensaje}'!='')
                    {alert('#{ManagedActualizacionCostos.mensaje}');terminarProgressBar();}else{alert('Se actualizaron los costos');terminarProgressBar();}" />

                    <a4j:commandButton value="Actualizar Costos Traspasos"  styleClass="btn" onclick="iniciarProgressBar()"  action="#{ManagedActualizacionCostos.actualizarCostos_actionTraspasos}"
                    reRender="panelContenidoActualizacion"
                    oncomplete = "if('#{ManagedActualizacionCostos.mensaje}'!='')
                    {alert('#{ManagedActualizacionCostos.mensaje}');terminarProgressBar();}else{alert('Se actualizaron los costos');terminarProgressBar();}" />
