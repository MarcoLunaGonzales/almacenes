package reportes.reporteExistenciasEstado1;
    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteExistenciasAlmacenEstado.jsp')" />
