...
<html>
    ...
    <body>
        <h3 align="center">REPORTE DE RESUMEN DE SALIDAS</h3>
        <form method="post" action="reporteResumenSalidas.jsp" target="_blank" name="form1">
            ...
            ResultSet rs = st.executeQuery(sql);
                        ...
                        <td style="padding:8px">
                            ...
                            %>
                            <select id="codAlmacenSelect"  name="codAlmacenSelect" class="inputText" multiple size="5" >
                                <%
                                while (rs_a.next()) {
                    ...
                    <tr class="outputText3" >
                        ...
                        %>
                        <td style="padding:8px">
                            <select id="codTipoSalida" name="codTipoSalida" multiple size="10" class="outputText3">
                                <%
            ...
            ResultSet rs = st.executeQuery(sql);
                        ...
                        <td class="">
                         ...
                         <td>Tipo de Reporte</td>
                            <td>::</td>
                            <td>
                        <select id="codTipoReporte" name="codTipoReporte" class="outputText3" >
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                <input type="button" class="btn"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteResumenSalidas.jsf')"/>
                            </td>
                        </tr>
                    </tfoot>
