...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                        ...
                        <rich:dataTable value="#{ManagedRegistroSalidaAlmacen.salidasAlmacenDetalleList}"
                            ...
                            <rich:column>
                                ...
                                <h:selectBooleanCheckbox value="#{data.checked}" 
                                                         rendered="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.tiposSalidasAlmacen.editable
                                                                    or( ManagedSalidaAlmacen.permisoEditarEmpaquePrimarioLote 
                                                                        and data.materiales.grupos.capitulos.codCapitulo eq 3)}" />
                            </rich:column>
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn"                    
                                       ...
                                       oncomplete="mostrarMensajeTransaccionEvento(function(){redireccionar('navegadorSolicitudAnular.jsf');})"
                                       />
                    <a4j:commandButton value="Cancelar" styleClass="btn" 
                                       ...
                                       oncomplete="location='navegadorSolicitudAnular.jsf'" 
                                       />
                        ...
                        <h:panelGroup id="contenidoModificarCantidadMaterial">
                            ...
                            <div align="center">
                                ...
                                <a4j:commandButton styleClass="btn" value="Guardar"
                                                   ...
                                                   reRender="dataSalidasAlmacenDetalle"  onclick="Richfaces.hideModalPanel('panelModificarCantidadMaterial')"
                                                   />
            ...
            <a4j:include viewId="/salidasAlmacen/panelAgregarItemSalida.jsp" id="pAgregarItem"/>
            <a4j:include viewId="/salidasAlmacen/panelDetalleItemSalida.jsp" id="pDetalleItemSalida"/>
