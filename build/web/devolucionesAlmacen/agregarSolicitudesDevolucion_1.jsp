            ...
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <br>
                        ...
                        action="#{ManagedSolicitudDevoluciones.guardarDevolucion_action}"
                            ...
                            <rich:dataTable value="#{ManagedSolicitudDevoluciones.devolucionesDetalle.devolucionesDetalleEtiquetasList}"
                                          ...
                                          <h:column>
                                            ...
                                            <h:column>
                                                ...
                                                <h:inputText value="#{data.cantidadFallados}" styleClass="inputText" onkeypress="valNum(event);" onkeyup="if(#{data.materiales.codMaterial!='11887'}){validaCantidad(this);}"  />
                                            </h:column>
