    ...
    <html>
       ...
       function hallaCantidadSalidaFisica(){
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedDevolucionAlmacen.cargarAgregarDevolucionAlmacen}"/>
                ...
                <rich:panel style="width:80%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:inputTextarea styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.obsSalidaAlmacen}" rows="4" cols="50" />
                    ...
                    <rich:dataTable value="#{ManagedDevolucionAlmacen.devolucionesDetalleList}"
                                    ...
                                    binding="#{ManagedDevolucionAlmacen.devolucionesDetalleDataTable}" style="width:80%">
                    ...
                    <br>
                        ...
                        action="#{ManagedDevolucionAlmacen.guardarDevolucion_action}"
