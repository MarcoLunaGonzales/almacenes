            ...
            <a4j:form id="form1">
                <div align="center">
                  ...
                  <rich:panel style="width:80%" headerClass="headerClassACliente">
                    ...
                    oncomplete="alert('#{ManagedIngresoAlmacenOrdenCompra.mensaje}');if(#{ManagedIngresoAlmacenOrdenCompra.mensaje!=''}){alert('#{ManagedIngresoAlmacenOrdenCompra.mensaje}')}else{ window.onbeforeunload = null;location='navegadorIngresosAlmacenOrdenCompra.jsf'}"
                    />
                    <%--
