...
<%
            ...
            parameters.put("codIngresoAlmacen", ingresosAlmacen.getCodIngresoAlmacen());

            parameters.put("dirLogoCofar", application.getRealPath("/img/cofar.png"));

            String reportFileName = application.getRealPath("/ingresosAlmacen/impresionIngresoAlmacenLog.jasper");
            Connection con = null;
            ...
            String separador = "";
            while (rs3.next()) {
                nombreGrupo = nombreGrupo + separador + rs3.getString("NOMBRE_GRUPO");
                if(primerRegistro){
