    ...
    <body >
        <a4j:form id="form1">
            ...
            <div align="center">
                ...
                <%--h:commandButton value="Buscar"  styleClass="outputText2"   action="#{ManagedIngresoAlmacenOrdenCompra.buscarProductosOnClickK}"  /--%>
                <a4j:commandButton value="Buscar" reRender="dataOrdenesCompra" styleClass="outputText2"   action="#{ManagedIngresoAlmacenOrdenCompra.buscarProductosOnClickK}"  />
