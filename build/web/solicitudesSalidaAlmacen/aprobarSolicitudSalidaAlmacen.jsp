            ...
            <a4j:form id="form1">
                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.codLoteProduccion}" styleClass="outputText2" id="codLoteProduccion" >
                            </h:outputText>
                    ...
                    --%>
                     ...
                     <rich:dataTable value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalidaAlmacenDetalleList}"
                       ...
                       <rich:column>
                            ...
                            <h:selectBooleanCheckbox value="#{data.checked}" rendered="#{data.estadosSolicitudSalidasAlmacen.codEstadoSolicitudSalidaAlmacen!='2' && data.estadosSolicitudSalidasAlmacen.codEstadoSolicitudSalidaAlmacen!='4'&&data.estadosSolicitudSalidasAlmacen.codEstadoSolicitudSalidaAlmacen!='5'}" />
