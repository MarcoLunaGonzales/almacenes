        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.cargarContenidoRegistroSolicitudAlmacenes}"/>
                    <br><br>
                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="Almacen:" styleClass="outputText2" />
                            <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.almacenes.codAlmacen}" id="codAlmacenSolicitud" >
                        ...
                        <%--
                            ...
                            <h:outputText value="Orden de Trabajo:" styleClass="outputText2" />
                            <h:inputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.ordenTrabajo}" styleClass="outputText2"  >
                            </h:inputText>
                           ...
                           <h:panelGrid columns="4" id="contenidoIngresoAlmacenDetalle" headerClass="headerClassACliente" width="90%" style="border:1px solid #000000;" >
                            ...
                            <rich:dataTable value="#{ManagedRegistroSolicitudSalidaAlmacen.materialesBuscarList}" var="data"
                                ...
                                <rich:column style="background-color: #{data.colorFila}">
                                    ...
                                    <a4j:commandLink  action="#{ManagedRegistroSolicitudSalidaAlmacen.detallarCantidadSalida_action1}" styleClass="#{data.colorFila}"  reRender="nombreMaterialAgregar,detalleSalidaMaterial,dataBuscarMaterial" >
                            ...
                            <h:panelGrid columns="11" id="detalleSalidaMaterial" headerClass="headerClassACliente" style="width:100%" >
                                ...
                                <h:selectOneMenu value="#{ManagedRegistroSolicitudSalidaAlmacen.ingresosAlmacenDetalleEstado.estadosMaterial.codEstadoMaterial}" styleClass="inputText" >
                                    ...
                                    <a4j:support event="onchange" action="#{ManagedRegistroSolicitudSalidaAlmacen.estadoMaterial_change1}" reRender="nombreMaterialAgregar,detalleSalidaMaterial,dataBuscarMaterial" />
                                </h:selectOneMenu>
