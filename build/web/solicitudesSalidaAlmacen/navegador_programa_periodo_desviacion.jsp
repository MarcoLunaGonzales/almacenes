                ...
                <div align="center">
                    ...
                    <%--br> <br--%>
                        ...
                        <rich:dataTable value="#{ManagedProgramaProduccion.programaProduccionPeriodoList}" var="data" id="dataProgramaProduccion"
                                    ...
                                    style="width=100%"
                                    >
                                        <%-- binding="#{ManagedProgramaProduccion.programaProduccionPeriodoDesviacionDataTable}" --%>
                        <%--rich:column >
                            <f:facet name="header">
                                <h:outputText value=""  />
                            </f:facet>
                        ...
                        <rich:column  >
                            ...
                            <a4j:commandLink styleClass="outputText2" onclick="location='navegador_programa_produccion_desviacion.jsf?codProgramaProd=#{data.codProgramaProduccion}'">
                        ...
                        <h:panelGroup id="contenidoBuscarLoteProduccion">
                            ...
                            <h:panelGrid columns="2">
                                ...
                                <h:inputText value="#{ManagedProgramaProduccion.programaProduccionBuscar.codLoteProduccion}" styleClass="inputText2" />
                                 ...
                                 <a4j:commandButton value="Aceptar" onclick = "location ='navegador_programa_produccion_desviacion.jsf'" styleClass="btn"/>
