    ...
    <html>
        <head>
            ...
            <script>
                ...
                function onLoad() {
                    if (document.getElementById("form1:codAreaEmpresa") != null) {
                        document.getElementById("form1:codAreaEmpresa").disabled = true;
                    }
                    if (document.getElementById("form1:codCompProd") != null) {
                        document.getElementById("form1:codCompProd").disabled = true;
                    }
                }
            </script>
                ...
                <div align="center">
                    ...
                    <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="Nro Lote:" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" />
                            <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.codLoteProduccion}" styleClass="outputText2" id="codLoteProduccion" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" >
                            </h:outputText>
                            <h:outputText value="Producto:" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" />
                            <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.componentesProd.codCompprod}" id="codCompProd" style="width:350px" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}"  >
...
<h:outputText value="Versión:" styleClass="outputText2" />
<h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.programaProduccion.nro_version}" styleClass="outputText2" />

                            <h:outputText value="Presentacion:" styleClass="outputText2" 
                                          rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" 
                                          
                                          />
                            <h:selectOneMenu  styleClass="inputText" 
                                              value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.presentacionesProducto.codPresentacion}" 
                                              id="codPresentacion" 
                                              rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" 
                                              disabled="true"
                                              >
                            ...
                            <h:outputText value="Maquinaria:" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen eq '14'}" />
                            <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.maquinaria.nombreMaquina}" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen eq '14'}" >
                            </h:outputText>

                            <h:outputText value="Instalacion:" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen eq '14'}" />
                            <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.areasInstalaciones.nombreAreaInstalacion}" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen eq '14'}" >
                            </h:outputText>
                    ...
                    <div align="left">
                        <h:panelGroup>
                            <a4j:commandButton value="Agregar Item" styleClass="btn"
                                               ...
                                               action="#{ManagedRegistroSolicitudSalidaAlmacen.agregarItem_action}"
                                               rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.usuarioModuloBean.codUsuarioGlobal eq '1893'}"  
                            ...
                            <h:panelGroup>
                                <a4j:commandButton value="Editar Item" styleClass="btn"
                                                   ...
                                                   /><%-- rendered="#{ManagedRegistroSolicitudSalidaAlmacen.codTipoSolicitudSalidaAlmacen!=2}" --%>
                    ...
                    oncomplete="if(#{ManagedSolicitudSalidaAlmacen.mensaje!=''}){alert('#{ManagedSolicitudSalidaAlmacen.mensaje}')}else{location='navegadorSolicitudesSalidaAlmacen.jsf'}"
                    /--%>
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn"
                                       ...
                                       if('#{ManagedRegistroSolicitudSalidaAlmacen.mensaje}'!='no se selecciono un area/departamento'){location='navegadorSolicitudesSalidaAlmacen.jsf';}
                                       }else{location='navegadorSolicitudesSalidaAlmacen.jsf'}"
                                       />
                    <a4j:commandButton value="Volver" styleClass="btn"
                                       oncomplete="redireccionar('agregarSolicitudSalidaAlmacenProgramaProduccion.jsf')"/>
                    ...
                    <a4j:form id="form5">
                        <h:panelGroup id="contenidoAgregarItem">
                            <div align="center">
                                <h:panelGrid columns="4" id="contenidoIngresoAlmacenDetalle" headerClass="headerClassACliente" width="90%" style="border:1px solid #000000;" >
                                    ...
                                    <a4j:commandButton value="Buscar" action="#{ManagedRegistroSolicitudSalidaAlmacen.buscarMaterial_action}" styleClass="btn"  reRender="dataBuscarMaterial"  />
                                ...
                                <h:panelGrid columns="11" id="detalleSalidaMaterial" headerClass="headerClassACliente" style="width:100%" >
                                    ...
                                    <h:panelGroup>
                                        ...
                                        <h:inputText value="#{ManagedRegistroSolicitudSalidaAlmacen.salidasAlmacenDetalleAgregar.cantidadSalidaAlmacenEquivalente}" styleClass="inputText" id="cantidadEquivalencia" />
                                        <h:outputText value="[" styleClass="outputText1" />
                        ...
                        <div align="center">
                            <a4j:commandButton styleClass="btn" value="Guardar"
                                               onclick="if(parseFloat(document.getElementById('form5:cantidadSalidaAlmacen').value)<=0){alert('Debe registrar una cantidad mayor a 0');return false;}"
                    ...
                    <a4j:form id="form4">
                        <h:panelGroup id="contenidoModificarCantidadMaterial">
                            <h:panelGrid columns="3">
                                ...
                                <h:outputText value="::" styleClass="outputText1" />
                                <h:panelGroup>
                                    <h:inputText value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalidaDetalle.cantidad}"  styleClass="inputText" id="cantidadSalidaAlmacen"  onkeypress="valNumPositivo(event);" onkeyup="calculaEquivalencia1(this)" /><%-- onkeyup="validaCantidadSalidaAlmacenDetalle1(this)" --%>
                            ...
                            <div align="center">
                                ...
                                <a4j:commandButton styleClass="btn" value="Guardar"
                                                   ...
                                                   onclick="if(parseFloat(document.getElementById('form4:cantidadSalidaAlmacen').value)<=0){alert('Debe registrar una cantidad mayor a 0'); return false;}"
                                                   reRender="dataSalidasAlmacenDetalle"  oncomplete="javascript:Richfaces.hideModalPanel('panelModificarCantidadMaterial')"
                                                   />
