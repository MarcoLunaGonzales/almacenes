                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:inputText value="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.codLoteProduccion}" styleClass="inputText" id="codLoteProduccion"  >
                                ...
                                oncomplete="if(#{ManagedRegistroSalidaAlmacen.mensaje!=''}){alert('#{ManagedRegistroSalidaAlmacen.mensaje}');}if(#{ManagedRegistroSalidaAlmacen.productoHabilitado==true}){document.getElementById('form1:codProducto').disabled=true;}else{document.getElementById('form1:codProducto').disabled=false;}" status="none" />
                                <%--
                            ...
                            <h:panelGroup id="producto">
                                <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.componentesProd.codCompprod}" id="codProducto" >
                                    ...
                                    <a4j:support event="onchange" action="#{ManagedRegistroSalidaAlmacen.producto_changed}" reRender="presentacionProducto,producto" oncomplete="if(#{ManagedRegistroSalidaAlmacen.mensaje!=''}){alert('#{ManagedRegistroSalidaAlmacen.mensaje}');}" />
                                </h:selectOneMenu>
                                <a4j:commandLink  action="#{ManagedRegistroSalidaAlmacen.detallarMateriales_action}" reRender="dataSalidasAlmacenDetalle">
                            ...
                            <h:inputText value="#{ManagedRegistroSalidaAlmacen.salidasAlmacen.ordenTrabajo}" styleClass="inputText" />
                             ...
                             oncomplete="Richfaces.showModalPanel('panelAsociarOC')" reRender="contenidoAsociarOC"/>
                             <%--final ale--%>
                             </h:panelGroup>
                   ...
                   <a4j:commandButton value="Guardar" styleClass="btn" id="buttonGuardar"
                    ...
                    oncomplete="if(#{ManagedRegistroSalidaAlmacen.mensaje!=''}){alert('#{ManagedRegistroSalidaAlmacen.mensaje}');ocultarProgreso();}else{location='navegadorSalidasAlmacen.jsf'}"
                    />
                    <h:panelGrid>
            ...
            <%--inicio ale--%>
             <rich:modalPanel id="panelAsociarOC" minHeight="380"  minWidth="980"
                        ...
                        <h:panelGroup id="contenidoAsociarOC">
                            <h:panelGrid columns="9">
                              ...
                              <h:outputText value="Fecha Final " styleClass="outputText1" />
                                ...
                                <h:selectOneMenu style="width:210px" value="#{ManagedRegistroSalidaAlmacen.codCapitulo}" styleClass="inputText" id="capitulos" >
                                    <f:selectItems value="#{ManagedRegistroSalidaAlmacen.capitulosList}"  />
                                    <a4j:support event="onchange" action="#{ManagedRegistroSalidaAlmacen.grupos_OC}"  reRender="gruposOC"/>
                                </h:selectOneMenu>
                                   <h:outputText value="Grupo" styleClass="outputText1" />
                                <h:outputText value="::" styleClass="outputText1" />
                                <h:selectOneMenu style="width:210px" value="#{ManagedRegistroSalidaAlmacen.codGrupo}" styleClass="inputText" id="gruposOC" >
                                    <f:selectItems value="#{ManagedRegistroSalidaAlmacen.gruposList}"  />
                                    <a4j:support action="#{ManagedRegistroSalidaAlmacen.materiales_OC}" event="onchange" reRender="materialesOC"/>
                                </h:selectOneMenu>
                                   <h:outputText value="Material" styleClass="outputText1" />
                                <h:outputText value="::" styleClass="outputText1" />
                            ...
                            <center>
                                <a4j:commandButton value="buscar" action="#{ManagedRegistroSalidaAlmacen.cargarOrdenesCompra}" styleClass="btn" reRender="dataOrdenCompra,dataDetalleOrdenCompra,controles"/>
                            </center>
                            ...
                            <rich:dataTable value="#{ManagedRegistroSalidaAlmacen.ordenesCompraList}" var="data"
                              ...
                              <rich:column>
                                ...
                                <a4j:commandLink  styleClass="outputText1" value="#{data.nroOrdenCompra}" action="#{ManagedRegistroSalidaAlmacen.cargarDetalleOrdenCompra}" reRender="dataDetalleOrdenCompra">
                              ...
                              <h:panelGrid columns="2"  width="50" id="controles">
                                  <a4j:commandLink  action="#{ManagedRegistroSalidaAlmacen.atras_action}"   rendered="#{ManagedRegistroSalidaAlmacen.begin!='1'}" reRender="dataOrdenCompra,controles,dataDetalleOrdenCompra">
                                <h:graphicImage url="../img/previous.gif"  style="border:0px solid red"   alt="PAGINA ANTERIOR"  />
                            </a4j:commandLink>
                            <a4j:commandLink  action="#{ManagedRegistroSalidaAlmacen.siguiente_action}"  rendered="#{ManagedRegistroSalidaAlmacen.cantidadfilas>='5'}" reRender="dataOrdenCompra,controles,dataDetalleOrdenCompra">
                            ...
                            <div align="center">
                                ...
                                oncomplete="javascript:Richfaces.hideModalPanel('panelAsociarOC');" onclick="if(editarItem('formAsociar:dataOrdenCompra')==false){return false}"
                                             />
