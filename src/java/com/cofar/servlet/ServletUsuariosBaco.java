...
/*        String codigo=request.getParameter("codigo");
    ...
    public void  generaMenuXml(String codigo, String codigoPersonal,PrintWriter writer) throws IOException{
        ...
        try {
            ...
            sql1+=" from bloquesmenu_almacenes";
            ...
            for(int i=1;i<=row;i++){
                ...
                sql2+=" from ventanas_almacenes v,usuarios_accesos_modulos_baco u";
                sql2+=" where v.codigo_ventana=u.codigo_ventana and u.cod_modulo=2 ";
