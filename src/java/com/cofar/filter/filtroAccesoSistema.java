...
public class filtroAccesoSistema implements Filter {
    ...
    private static final String URL_PAGINA_REPORTE_OC = "reporteOrdenCompra.jsf";
    private static final String URL_PAGINA_REPORTE_SOLICITUD_OC = "reporteSolicitudCompra.jsf";
    private static final String URL_PAGINA_SELECCION_ALMACEN = "navegadorSeleccionAlmacen.jsf";
        ...
        if (debug) {
            ...
            boolean direccionPermitida = (req.getRequestURI().split("/").length == 2 ? true : 
                                                req.getRequestURI().split("/")[2].equals(this.URL_FOLDER_ERROR)
                                                        ...
                                                        || req.getRequestURI().split("/")[2].equals(this.URL_PAGINA_SELECCION_ALMACEN)
                                                        || req.getRequestURI().contains(this.URL_PAGINA_REPORTE_OC)
                                                        || req.getRequestURI().contains(this.URL_PAGINA_REPORTE_SOLICITUD_OC)
