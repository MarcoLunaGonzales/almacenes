...
public class ManagedIngresoAlmacenOrdenCompra1 extends ManagedBean{
    ...
    public ManagedIngresoAlmacenOrdenCompra1() {
    }
    ...
    public void cargarContenidoIngresoAlmacenOrdenCompra(){
        try {
            ...
            String consulta = " select * from (select ROW_NUMBER() OVER (ORDER BY oc.nro_orden_compra desc ,oc.fecha_entrega desc) as 'FILAS'," +
                    ...
                    " and oc.cod_estado_compra in (4,5,6,7,13,15)  ) AS listado_ordenes_compra where FILAS BETWEEN " + begin + " AND " + end + "  ";
