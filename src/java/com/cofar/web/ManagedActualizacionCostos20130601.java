 ...
 * @author hvaldivia
 */
public class ManagedActualizacionCostos20130601 {
    ...
    public ManagedActualizacionCostos20130601() {
    }
    ...
    public String buscarMaterial_action() {
        try {
            ...
            consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL, gr.COD_GRUPO,gr.NOMBRE_GRUPO,c.COD_CAPITULO,c.NOMBRE_CAPITULO " +
                    ...
                    " or(c.COD_CAPITULO = sd.COD_CAPITULO  )) " +
                    " and a.COD_ALMACEN =" + almacenes.getCodAlmacen() + "" +
                    " and m.NOMBRE_MATERIAL like '" + materiales.getNombreMaterial() + "%' and m.MOVIMIENTO_ITEM = 1 and m.COD_ESTADO_REGISTRO = 1 " +
                    " order by c.NOMBRE_CAPITULO,gr.NOMBRE_GRUPO asc  "; //m.NOMBRE_MATERIAL
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (materialesItem.getChecked().booleanValue() == true) {
                    ...
                    sql_ingresos += " select i.COD_INGRESO_ALMACEN from INGRESOS_ALMACEN i where i.COD_GESTION in (8,9) and i.COD_ALMACEN in (4,9)";
...
//                    st.executeUpdate(consulta);
                    ...
                    saldoAnterior = this.redondear(saldoTotalAnterior, 2);
...
//                        //proceso de actualizacion de costos
                        ...
                        if (kardexItemMovimiento.getTipo().equals("Ingreso")) {
                            ...
                            System.out.println("consulta " + consulta);
                            st1.executeUpdate(consulta);
                            if (kardexItemMovimiento.getCodTipoIngresoSalida() == 6) {
                                consulta = " update ingresos_almacen_detalle set fecha_actualizacion='" + sdf.format(kardexItemMovimiento.getFecha()) + " 00:00:00'," +
