    ...
    <html>
            ...
            function validaFechaDDMMAAAA(fecha){
                    ...
                    function cerrarOT()
                    {
                        ...
                        if(cerrar!=null)
                        {
                            if(cerrar.checked)
                                {
                                    if(confirm('Esta seguro de cerrar la Orden de Trabajo?')==true)
                                        {
                                            return true;
                                        }
                                    else
        ...
        <body >
            ...
            <a4j:form id="form1">
             ...
             <rich:modalPanel id="panelSeguimiento"  minHeight="400"  minWidth="1000"
             ...
             <rich:modalPanel id="panelAsociarOT"  minHeight="350"  minWidth="800"
                                     ...
                                     resizeable="true" style="overflow :auto" >
                        <f:facet name="header">
                            <h:outputText value="Asociar a Orden de Trabajo"/>
                        </f:facet>
                        <a4j:form id="form11">
                                ...
                                <rich:dataTable value="#{ManagedSeguimientoSolicitudMantenimiento.ordenesTrabajoDataModel}"
                                    ...
                                    headerClass="cabecera" >
                                        ...
                                        <rich:column>
                                            <h:outputText value="#{data.tiposSolicitudMantenimiento.nombreTipoSolMantenimiento}" styleClass="outputText2"/>
                                        </rich:column>
