        ...
        <body >
            ...
            <a4j:form id="form1">
                <div align="center">
                    ...
                    action="#{ManagedSolicitudMantenimiento.aprobarSolicitudMantenimiento_action}"
                    reRender="dataSolicitudMantenimiento"
                    onclick="javascript:if(validarSeleccion('form1:dataSolicitudMantenimiento')==false){return false;}else{if(confirm('Esta seguro que desea aprobar la solicitud?')==false){return false}}"/>
            ...
            <rich:modalPanel id="panelComentarioEstado"  minHeight="200"  minWidth="500"
             ...
             <rich:modalPanel id="panelEditarTipoMantenimientoSolicitudMantenimiento"  minHeight="120"  minWidth="500"
                        ...
                        <h:panelGroup id="contenidoEditarTipoMantenimientoSolicitudMantenimiento">
                                ...
                                <h:panelGrid columns="3" styleClass="navegadorTabla" >
                                    ...
                                    <h:selectOneMenu  styleClass="inputText" value="#{ManagedSolicitudMantenimiento.solicitudMantenimientoItem.tiposSolicitudMantenimiento.codTipoSolMantenimiento}">
