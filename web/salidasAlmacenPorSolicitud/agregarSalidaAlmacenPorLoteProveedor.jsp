        ...
        <body onload="load1()">
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedSolicitudSalidaAlmacen.cargarContenidoRegistroSalidaAlmacenPorLoteProveedor}"/>
                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                            <f:facet name="header">
                                <h:outputText value="Registro de Salidas a Almacen Por Lote Proovedor"  />
                            </f:facet>
                            <h:panelGrid columns="6" id="panelContenidoSalidaAlmacen">
                            ...
                            <h:outputText value="::" styleClass="outputTextBold" />
                            <h:outputText value="#{ManagedSolicitudSalidaAlmacen.salidasAlmacen.areasEmpresa.nombreAreaEmpresa}" styleClass="outputText2" />
                        ...
                        <div style="overflow:auto;height:200px;width:80%;text-align:center">
                            <rich:dataTable value="#{ManagedSolicitudSalidaAlmacen.ingresosAlmacenDetalleSalidaList}"
                                    var="data"
                            ...
                            <rich:columnGroup >
                                ...
                                <rich:column>
                                    <h:outputText value="Cantidad<br>Total<br>Solicitud" escape="false" style="color:black !important" />
                                </rich:column>
                                <rich:column>
                                ...
                                <rich:column>
                                    <h:outputText value="Cantidad<br> Solicitud"  escape="false" style="color:black !important" />
                                </rich:column>
                                <rich:column>
                                    <h:outputText value="Cantidad<br>Restante"  escape="false" style="color:black !important" />
                                </rich:column>
                            </rich:columnGroup>
                        </f:facet>
                        ...
                        <rich:subTable var="subData" value="#{data.ingresosAlmacenDetalleEstadoList}" rowKeyVar="row">
                            ...
                            <rich:column  styleClass="#{subData.checked?'conExistencia':'sinExistencia'}">
                               <h:outputText value="#{subData.cantidadRestante}"  />
                            </rich:column>
                        </rich:subTable>
                    ...
                    <div id="buttonGuardar">
                        ...
                        action="#{ManagedSolicitudSalidaAlmacen.guardarSalidaAlmacenLoteProveedor_action}"
                        onclick="bloquearGuardar();if(confirm('Esta seguro de realizar la Salida de Almacen?')==false){desBloquearGuardar();return false;}"
                        oncomplete="if(#{ManagedSolicitudSalidaAlmacen.mensaje!='1'}){alert('#{ManagedSolicitudSalidaAlmacen.mensaje}');desBloquearGuardar();}else{window.location.href='navegadorSolicitudesSalidaAlmacen.jsf?data='+(new Date()).getTime().toString();}"
                        />
                    </div>
