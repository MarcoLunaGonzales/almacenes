        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h:outputText value="#{ManagedRegistroSolicitudSalidaAlmacen.cargarContenidoRegistroSolicitudSalidaAlmacenTraspaso}"/>
                    <br><br>
                    ...
                    <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        <f:facet name="header">
                            <h:outputText value="Registro de Solicitud Salidas a Almacen por Traspaso"  />
                        </f:facet>
                        <h:panelGrid columns="4" >
                            ...
                            <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudSalidaAlmacen.traspasos_solicitud.almacenDestino.codAlmacen}" id="codAlmacenSolicitud" >
                                <f:selectItems value="#{ManagedRegistroSolicitudSalidaAlmacen.almacenSolicitudList}"  />
                            </h:selectOneMenu>
                            <h:outputText value="Area / Departamento:" styleClass="outputText2" />
                            <h:selectOneMenu  styleClass="inputText" 
                                              value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.areaDestinoSalida.codAreaEmpresa}" 
                                              id="codAreaEmpresa" >
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn"
                                       action="#{ManagedRegistroSolicitudSalidaAlmacen.guardarSolicitudSalidaAlmacenTraspaso_action}"
                                       onclick="if(confirm('Esta seguro de realizar la Solicitud de Salida de Almacen?')==false){return false;}"
