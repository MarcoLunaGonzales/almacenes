...
<f:view>
    ...
    <html>
       ...
       function onLoad(){
           if(document.getElementById("form1:codAreaEmpresa")!=null){document.getElementById("form1:codAreaEmpresa").disabled=true;}
           if(document.getElementById("form1:codCompProd")!=null){document.getElementById("form1:codCompProd").disabled=true;}
       }
   </script>
            ...
            <a4j:form id="form1">
                ...
                <rich:panel style="width:100%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="Presentacion:" styleClass="outputText2" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" />
                            <h:selectOneMenu  styleClass="inputText" value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.presentacionesProducto.codPresentacion}" id="codPresentacion" rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.almacenesGlobal.codAlmacen != '14'}" >
                            ...
                            <h:inputTextarea  rows="5" cols="50" styleClass="outputText2" value="#{ManagedRegistroSolicitudSalidaAlmacen.solicitudesSalida.obsSolicitud}" />
                             ...
                             oncomplete="Richfaces.showModalPanel('panelAgregarItem')" action="#{ManagedRegistroSolicitudSalidaAlmacen.agregarItem_action}"
                             rendered="#{ManagedRegistroSolicitudSalidaAlmacen.usuario.usuarioModuloBean.codUsuarioGlobal eq '826'}" reRender="contenidoAgregarItem"
                              />
