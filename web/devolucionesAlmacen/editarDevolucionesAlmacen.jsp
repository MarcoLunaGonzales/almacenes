...
<f:view>
    ...
    <html>
        ...
        if((parseFloat(cantidadBuenos1)+ parseFloat(cantidadFallados1))>(cantidadDisponible-cantidadEntregada)){
       ...
       function hallaCantidadSalidaFisica(){
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    <h:outputText value="#{ManagedDevolucionAlmacen.cargarEditarDevolucionesAlmacen}"/>
                ...
                <rich:panel style="width:80%"  headerClass="headerClassACliente">
                        ...
                        <h:panelGrid columns="4" >
                            ...
                            <h:outputText value="#{ManagedDevolucionAlmacen.salidasAlmacen.nroSalidaAlmacen}" styleClass="outputText1" />

                            <h:outputText value="Area / Departamento:" styleClass="outputText2" />
                            <h:outputText  styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.areasEmpresa.nombreAreaEmpresa}"  />

                            <h:outputText value="Tipo de Salida:" styleClass="outputText2" />
                            <h:outputText styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.tiposSalidasAlmacen.nombreTipoSalidaAlmacen}"   />
                                

                            <h:outputText value="Nro Lote:" styleClass="outputText2" />
                            <h:outputText value="#{ManagedDevolucionAlmacen.salidasAlmacen.codLoteProduccion}" styleClass="outputText1" />

                            <h:outputText value="Producto:" styleClass="outputText2" />                            
                            <h:outputText  styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.componentesProd.nombreProdSemiterminado}"   />
                                

                            <h:outputText value="Presentacion:" styleClass="outputText2"  />
                            <h:outputText  styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.presentacionesProducto.nombreProductoPresentacion}"  id="presentacionProducto" />
                            

                            <h:outputText value="Observaciones:" styleClass="outputText2" />
                            <h:outputText styleClass="outputText1" value="#{ManagedDevolucionAlmacen.salidasAlmacen.obsSalidaAlmacen}" />

                            <h:outputText value="Orden de Trabajo:" styleClass="outputText2" />
                            <h:outputText value="#{ManagedDevolucionAlmacen.salidasAlmacen.ordenTrabajo}" styleClass="outputText1" />
                    ...
                    <rich:dataTable value="#{ManagedDevolucionAlmacen.devolucionesDetalleList}"
                                    var="data"
                                    id="dataDevolucionesDetalleAlmacen"
                                    onRowMouseOut="this.style.backgroundColor='#FFFFFF';"
                                    onRowMouseOver="this.style.backgroundColor='#DDE3E4';"
                                    headerClass="headerClassACliente"
                                    binding="#{ManagedDevolucionAlmacen.devolucionesDetalleDataTable}" >
                                  ...
                                  <h:column>
                                    ...
                                    <h:column>
                                        ...
                                        <a4j:commandLink onclick="Richfaces.showModalPanel('panelDevolucionAlmacenDetalleEtiquetas')"
                                              action="#{ManagedDevolucionAlmacen.verDevolucionesDetalleEtiquetas_action}"
                    ...
                    <br>
                        ...
                        action="#{ManagedDevolucionAlmacen.guardarEditarDevolucion_action}"
                        oncomplete="if(#{ManagedDevolucionAlmacen.mensaje!=''}){alert('#{ManagedDevolucionAlmacen.mensaje}')}else{location='navegadorDevolucionesAlmacen.jsf'}"
              ...
              <rich:modalPanel id="panelDevolucionAlmacenDetalleEtiquetas" minHeight="400"  minWidth="650"
                        ...
                        <h:panelGroup id="contenidoDevolucionAlmacenDetalleEtiquetas">
                            ...
                            <rich:dataTable value="#{ManagedDevolucionAlmacen.devolucionesDetalle.devolucionesDetalleEtiquetasList}"
                                            var="data"
                        ...
                        <div align="center">
                          ...
                          action="#{ManagedDevolucionAlmacen.registrarDevolucionesDetalleEtiquetas_action}"
