...
<f:view>
    ...
    <html>
        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <rich:panel style="width:80%" headerClass="headerClassACliente">
                        ...
                        <rich:panel  >
                            ...
                            <h:panelGroup rendered="#{ManagedIngresoAlmacen.salidasAsociadasAlmacenListSize ne 0}" >
                                <h:outputText value="Salidas automáticas del Ingreso que serán anuladas: " styleClass="outputText1" rendered="#{ManagedIngresoAlmacen.tipoSalidaAutomatico && !ManagedIngresoAlmacen.salidaTieneDevolucion}"/>
                        ...
                        <div align="center">
                            <a4j:commandButton value="Agregar Item" styleClass="btn"
                                               ...
                                               rendered="#{ManagedIngresoAlmacen.ingresosAlmacen.tiposIngresoAlmacen.editable}"
                                               />
                    ...
                    <rich:dataTable value="#{ManagedIngresoAlmacen.ingresosAlmacenDetalleList}" var="data"
                        ...
                        <h:column>
                            ...
                            <a4j:commandLink action="#{ManagedIngresoAlmacen.detallarIngresosAlmacenDetalleEditarAction}" 
                                             rendered="#{ManagedIngresoAlmacen.ingresosAlmacen.tiposIngresoAlmacen.editable}"
                                             onclick="Richfaces.showModalPanel('panelDetalleItem')" 
                    ...
                    <a4j:commandButton value="Guardar" styleClass="btn"                    
                                       ...
                                       oncomplete="mostrarMensajeTransaccionEvento(function(){redireccionar('navegadorSolicitudValidar.jsf');});"/>
                    <a4j:commandButton value="Cancelar" styleClass="btn" 
                                       ...
                                       oncomplete="location='navegadorSolicitudValidar.jsf'" 
                                       />
                </a4j:form>
            ...
            <a4j:include viewId="/ingresosAlmacen/panelDetallarItem.jsp" id="detalleItem"/>
