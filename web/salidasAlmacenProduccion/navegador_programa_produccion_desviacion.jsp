            ...
            <a4j:form id="form1" onreset="alert('hola')"  oncomplete="Richfaces.showModalPanel('panelTipoSalidaAlmacenProduccion');" >
                ...
                <div align="center">
                    ...
                    <%--h:commandButton  value=" Generar Salidas de Almacen "
                     styleClass="btn"
                    action="#{ManagedProgramaProduccion.generarSalidaAlmacenes_action1}"
                     /-%><%-- onclick="if(seleccionarItem('form1:dataProgramaProduccion')==false){return false;}" --%>
                   
                        <h:commandButton  value=" Generar Salidas de Almacen Desviacion "
                         styleClass="btn"
                         action="#{ManagedProgramaProduccion.generarSalidaAlmacenesDesviacion_action}"
                         /><%-- onclick="if(seleccionarItem('form1:dataProgramaProduccion')==false){return false;}" --%>
