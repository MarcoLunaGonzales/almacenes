        ...
        <a4j:form id="form1">
            <div align="center">
                        ...
                        <h:panelGroup id="contenidoSalidaAlmacenProgramaProduccion">
                            ...
                            <h:panelGroup rendered="#{ManagedProgramaProduccion.salidaMateriaPrima
                                                      and ManagedProgramaProduccion.permisoSalidaMateriaPrima}">
                                <br>
                                <b> Materia Prima </b>
                                <br>
                                ...
                                <rich:dataTable value="#{ManagedProgramaProduccion.materiaPrimaList}" var="data" id="dataFormulaMP"
                                    ...
                                    <rich:column>
                                        <h:selectBooleanCheckbox value="#{data.checked}" id="checkMP"/>
                                    </rich:column>
                                    <rich:column>
                                        <h:outputLabel value="#{data.materiales.nombreMaterial}" for="checkMP"/>
                                    </rich:column>
                            ...
                            <br/>
                            <h:panelGroup rendered="#{ManagedProgramaProduccion.permisoSalidaEmpaquePrimario
                                                      and ManagedProgramaProduccion.salidaEmpaquePrimarioSecundario}">
                            ...
                            <rich:dataTable value="#{ManagedProgramaProduccion.empaquePrimarioList}"
                                            var="data" id="dataEmpaquePrimario"
                                            onRowMouseOut="this.style.backgroundColor='#FFFFFF';"
                                            onRowMouseOver="this.style.backgroundColor='#DDE3E4';"
                                            headerClass="headerClassACliente" width="80%">
                                <h:column>
                                    ...
                                    <h:selectBooleanCheckbox value="#{data.checked}" id="checkEp" />
                                </h:column>
                                ...
                                <h:column>
                                    ...
                                    <h:outputLabel value="#{data.materiales.nombreMaterial}" for="checkEp"/>
                    ...
                    <br/>
                    <h:panelGroup rendered="#{ManagedProgramaProduccion.permisoSalidaEmpaqueSecundario
                                                      and  ManagedProgramaProduccion.salidaEmpaquePrimarioSecundario}">
                            ...
                            <br/>
                                ...
                                <h:column>
                                   <f:facet name="header">
                                       <h:selectBooleanCheckbox value="#{ManagedProgramaProduccion.selectES}" id="datoEs" onclick="seleccionarTodosEs();" >


                                          </h:selectBooleanCheckbox>

                                      </f:facet>
                                      <h:selectBooleanCheckbox value="#{data.checked}" id="checkEs" />
                              </h:column>
                              ...
                              <h:column>
                                  ...
                                  <h:outputLabel for="checkEs" value="#{data.materiales.nombreMaterial}"/>
                              </h:column>
                              <h:column>
                                  <f:facet name="header">
                                      <h:outputText value="Cantidad"  />
                        ...
                        <h:panelGroup rendered="#{ManagedProgramaProduccion.administradorAlmacen}">
                            <a4j:commandButton value="Generar Salidas Almacen" styleClass="btn" action="#{ManagedProgramaProduccion.generarSalidasAlmacen_action}"  
                                               oncomplete="bloquearPantalla();"/>
