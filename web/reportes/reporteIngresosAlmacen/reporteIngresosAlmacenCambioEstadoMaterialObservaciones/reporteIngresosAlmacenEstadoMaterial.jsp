...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos - Seguimiento Cambio de Estado de Material</h4>
 ...
 /* NumberFormat numeroformato = NumberFormat.getNumberInstance(Locale.ENGLISH);
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    <td HEIGHT='25PX' class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center" ><b>Nro. Ingreso</b></td>
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Cantidad Ingreso</b></td>
                     <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Cantidad Restante</b></td>
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Unid.</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>-OBSERVACIONES-</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Personal Cambio Estado</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Fecha Ult. Cambio de Estado</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Estado actual del material</b></td>
                ...
                <%
                    ...
                    String consulta = " select "
                            ...
                            + "  mat.COD_MATERIAL,mat.NOMBRE_MATERIAL"
                            + "  ,iade.LOTE_MATERIAL_PROVEEDOR"
                            + "  ,iade.FECHA_VENCIMIENTO"
                            + " ,iade.FECHA_REANALISIS"
                            + "  ,em.NOMBRE_ESTADO_MATERIAL"
                            + "  ,sum(iade.CANTIDAD_PARCIAL)cantidad_ingreso"
                            + "  ,SUM(iade.CANTIDAD_RESTANTE)cantidad_restante"
                            + "  ,iade.FECHA_CAMBIO_ESTADO_MATERIAL"
                            + "  ,p.NOMBRES_PERSONAL+' '+ p.AP_PATERNO_PERSONAL nombre_completo"
                            + "  , iade.OBSERVACIONES,oc.nro_orden_compra,NOMBRE_TIPO_INGRESO_ALMACEN"
                            + ",nombre_proveedor,u.abreviatura,c.nombre_capitulo,g.nombre_grupo"
                            + " from INGRESOS_ALMACEN ia"
                            + " inner join INGRESOS_ALMACEN_DETALLE_ESTADO iade on ia.COD_INGRESO_ALMACEN=iade.COD_INGRESO_ALMACEN"
                       ...
                       + " left outer join PROVEEDORES pr on pr.COD_PROVEEDOR = ia.COD_PROVEEDOR " 
                        + " left join ordenes_compra oc on ia.COD_orden_compra=oc.COD_orden_compra"
                          
                            + " inner join MATERIALES mat on mat.COD_MATERIAL=iade.COD_MATERIAL"
                            +   " inner join UNIDADES_MEDIDA u on u.COD_UNIDAD_MEDIDA = mat.COD_UNIDAD_MEDIDA " 
                        
                            + " inner join grupos g on mat.COD_grupo=g.COD_grupo"
                            + " inner join capitulos c on c.COD_capitulo=g.COD_capitulo"
                            + " inner join PERSONAL p on p.COD_PERSONAL=iade.COD_PERSONAL_CAMBIO_ESTADO"
                            + " inner join ESTADOS_MATERIAL em on em.COD_ESTADO_MATERIAL=iade.COD_ESTADO_MATERIAL"
                            + " where ia.COD_ESTADO_INGRESO_ALMACEN=1"
                           
                        
                            + " and (iade.OBSERVACIONES is not null) and iade.OBSERVACIONES<>'' and iade.OBSERVACIONES<>'0'"
                           ;
                    if (!codMaterial.equals("0")) {
                        consulta = consulta + " and mat.cod_material in(" + codMaterial + ") ";
                    }
                    ...
                    consulta = consulta +  " group by ia.COD_INGRESO_ALMACEN, ia.NRO_INGRESO_ALMACEN,ia.FECHA_INGRESO_ALMACEN,"
                            + "  mat.COD_MATERIAL,mat.NOMBRE_MATERIAL,iade.LOTE_MATERIAL_PROVEEDOR,iade.FECHA_VENCIMIENTO,iade.FECHA_REANALISIS"
                            + "  ,iade.FECHA_CAMBIO_ESTADO_MATERIAL,p.NOMBRES_PERSONAL, p.AP_PATERNO_PERSONAL, iade.OBSERVACIONES"
                            + ",em.NOMBRE_ESTADO_MATERIAL,oc.nro_orden_compra,NOMBRE_TIPO_INGRESO_ALMACEN,pr.nombre_proveedor,u.abreviatura,c.nombre_capitulo,g.nombre_grupo"
                           + " order by ia.FECHA_INGRESO_ALMACEN asc";

                    System.out.println("consulta Jaime Obs Ingresos:---> " + consulta);
                    ...
                    while (rs.next()) {
                        ...
                        out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + format.format(rs.getDate("FECHA_INGRESO_ALMACEN")) + " &nbsp; " + format1.format(rs.getTimestamp("FECHA_INGRESO_ALMACEN").getTime()) + "</td>");
                        ...
                        out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("cantidad_ingreso"))) + "</td>");
                        out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("cantidad_restante"))) + "</td>");
                        
                        out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >" + (rs.getString("ABREVIATURA") == null ? "" : rs.getString("ABREVIATURA")) + "</td>");

                        out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + (rs.getString("OBSERVACIONES") == null ? "" : rs.getString("OBSERVACIONES")) + "</td>");
                        
                        out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + (rs.getString("nombre_completo") == null ? "" : rs.getString("nombre_completo")) + "</td>");
                        Date fecha_cambio = rs.getTimestamp("FECHA_CAMBIO_ESTADO_MATERIAL");
                        String dato_cambio = "";
                        if (fecha_cambio != null) {
                            dato_cambio = format.format(rs.getDate("FECHA_CAMBIO_ESTADO_MATERIAL")) + " &nbsp; " + format1.format(rs.getTimestamp("FECHA_CAMBIO_ESTADO_MATERIAL").getTime());
                        }

                        out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + dato_cambio + "</td>");

                        out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + (rs.getString("NOMBRE_ESTADO_MATERIAL") == null ? "" : rs.getString("NOMBRE_ESTADO_MATERIAL")) + "</td>");

                        out.print("</tr>");
                        costoTotal = costoTotal + rs.getDouble("cantidad_ingreso");
                    }
                    out.print("<tr>");
