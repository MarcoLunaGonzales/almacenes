...
function buscarMaterial(f){
                ...
                ajax.open("GET","ajaxMaterial.jsf?nombreMaterial="+nombreMaterial+"&codCapitulo="+arrayCodCapitulo+"&codGrupo="+arrayCodGrupo,true);
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
    ...
    <body>
        <h3 align="center">Reporte de Ingresos - Observaciones Registradas en Control de Calidad</h3>
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                        ...
                        <td class=""><input type="button" onclick="buscarMaterial(form1)" value="buscar" class="outputText2" ></td>
                        <td class=""></td>
                    </tr>
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Generar Reporte" name="reporte" onclick="verReporte(form1,'reporteIngresosAlmacenEstadoMaterial.jsp')" />
