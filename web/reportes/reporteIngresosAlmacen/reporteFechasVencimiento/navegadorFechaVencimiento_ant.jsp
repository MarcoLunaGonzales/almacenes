    ...
    <head>
        ...
        f.nombreAreaEmpresaP.value=arrayNombreAreaEmpresa;
            ...
            function buscarMaterial(f){
                ...
                ajax.open("GET","ajaxMaterial.jsf?codCapitulo="+arrayCodCapitulo+"&codGrupo="+arrayCodGrupo+"&nombreMaterial="+nombreMaterial+"&data="+(new Date()).getTime().toString(),true);
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
...
Connection con = null;
        try {
            ...
            e.printStackTrace();
                    ...
                    <tr class="outputText3">
                        ...
                        <td class="">::</td>
                        <td class="">
                            <input type="text" style="color:blue;text-transform:uppercase" class="inputText" size="55" name="nombreMaterial" />
                        </td>
                        <td class="">
        ...
        sql_reporte += " IA.NRO_INGRESO_ALMACEN,ia.FECHA_INGRESO_ALMACEN,iad.ETIQUETA,u.ABREVIATURA,ia.cod_ingreso_almacen,iad.cod_material,id.COD_UNIDAD_MEDIDA" +
                       ...
                       " ,iad.LOTE_MATERIAL_PROVEEDOR,id.COSTO_UNITARIO_ACTUALIZADO"+
        ...
        sql_reporte += " and m.nombre_material like '%%'";
        sql_reporte += " and m.COD_GRUPO in(SELECT COD_GRUPO FROM GRUPOS G WHERE cod_estado_registro=1)";
        //sql_reporte +=" --and G.cod_capitulo='+inttostr(lbc_capitulo.KeyValue)+'');";
        //sql_reporte +=" --and G.cod_grupo='+inttostr(lbc_grupo.KeyValue)+'');";
        ...
        catch(SQLException ex)
        {
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteFechaVencimiento.jsp')" />
