...
<html>
    ...
    <body>
        ...
        try {
            ...
            System.out.println("parametros fi:" + fechaInicial + " ff:" + fechaFinal + " cm:" + codMaterial + " cg:" + codGrupo + " cc:"+ codCapitulo + " ca:" + codAlmacen + " cs:" + codStock + " cf:" +
                    codFilial + " nf:" + nombreFilial + "  na:" + nombreAlmacen + " nc:" + nombreCapitulo + " ng:" + nombreGrupo);
            double costoTotal = 0;
