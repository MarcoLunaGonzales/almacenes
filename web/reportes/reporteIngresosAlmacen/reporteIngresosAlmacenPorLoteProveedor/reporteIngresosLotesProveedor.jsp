    ...
    <body>
        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                consulta = consulta + " inner join INGRESOS_ALMACEN_DETALLE_ESTADO iade on iade.COD_INGRESO_ALMACEN=ia.COD_INGRESO_ALMACEN and iade.COD_MATERIAL=iad.COD_MATERIAL";
                ...
                consulta = consulta + " left outer join proveedores p on p.COD_PROVEEDOR=ia.COD_PROVEEDOR"+
                                     ...
                                     " ia.COD_ORDEN_COMPRA and ocd.COD_MATERIAL = iade.COD_MATERIAL";
                consulta = consulta + " where ia.cod_estado_ingreso_almacen=1 ";
                    consulta = consulta + " and iade.CANTIDAD_RESTANTE>0.001"
               ...
               /* if (!fechaInicial.equals("") && !fechaFinal.equals("")) {
                ...
                if (!codProveedor.equals("") && !codProveedor.equals("0")) {
                    consulta = consulta + " and ia.COD_PROVEEDOR  in (" + codProveedor + ") ";
                }
                ...
                consulta = consulta + " GROUP BY isnull(ocd.LOTE_INTERNO,''),iad.cod_material, ia.COD_PROVEEDOR,iade.LOTE_MATERIAL_PROVEEDOR,iade.FECHA_VENCIMIENTO, iade.COD_ESTADO_MATERIAL,p.NOMBRE_PROVEEDOR,e.NOMBRE_ESTADO_MATERIAL,m.NOMBRE_MATERIAL order by m.NOMBRE_MATERIAL asc";
                ...
                while (rs.next()) {
                    ...
                    if(rs.getInt("cod_material")!=cod_material_ant){
                        if(c>0){
                            out.print("<tr>");
                            out.print("<th HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;' colspan = '3'  >TOTAL&nbsp;</th>");
                        ...
                        out.print("<tr>");
                            ...
                            out.print("<td class='border' style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" +(rs.getDate("FECHA_VENCIMIENTO")!=null?(sdfMMyyyy.format(rs.getDate("FECHA_VENCIMIENTO"))):"&nbsp")+ "</td>");
