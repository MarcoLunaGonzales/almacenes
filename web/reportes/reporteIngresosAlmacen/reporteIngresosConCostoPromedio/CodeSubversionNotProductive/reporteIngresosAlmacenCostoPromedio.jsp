package reportes.reporteIngresosAlmacen.reporteIngresosConCostoPromedio;
        ...
        <form>
            ...
            <table width="80%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " p.NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_UNITARIO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO,u.NOMBRE_UNIDAD_MEDIDA " +
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format( rs.getDouble("COSTO_UNITARIO")))+"</td>");
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+(formato.format( rs.getDouble("COSTO_UNITARIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO")))+"</td>");
                                out.print("</tr>");
                                costoTotal = costoTotal + rs.getDouble("COSTO_UNITARIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO");
                  }
                                out.print("<tr>");
