...
<html>
    ...
    <body>
        <form>
            <h4 align="center">REPORTE DE LIQUIDACIONES</h4>
        ...
        try {
            ...
            <table width="95%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td HEIGHT='35PX' style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center" ><b>Item</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"   align="center" ><b>Unid.</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center"><b>Cantidad</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center"><b>Precio U.</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center"><b>Precio T.</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center"><b>Costo U.</b></td>
                    <td  style="border-bottom : solid #D8D8D8 1px;border-right : solid #666666 1px;border-bottom : solid #666666 1px;" bgcolor="#cccccc"  align="center"><b>Costo T</b></td>
                 </tr>


                <%

                 String consulta = " SELECT m.NOMBRE_MATERIAL,um.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN,ia.FECHA_INGRESO_ALMACEN,";
                 consulta += " t.NOMBRE_TIPO_INGRESO_ALMACEN,p.NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,tc.NOMBRE_TIPO_COMPRA,ia.NRO_DOCUMENTO,";
                 consulta += " iad.PRECIO_UNITARIO_MATERIAL,iad.PRECIO_TOTAL_MATERIAL,iad.COSTO_UNITARIO,iad.PRECIO_NETO,ia.OBS_INGRESO_ALMACEN";
                 consulta += " FROM INGRESOS_ALMACEN ia";
                 consulta += " LEFT OUTER JOIN TIPOS_INGRESO_ALMACEN t  ON ia.COD_TIPO_INGRESO_ALMACEN=t.COD_TIPO_INGRESO_ALMACEN";
                 consulta += " LEFT OUTER JOIN PROVEEDORES p ON  ia.COD_PROVEEDOR=p.COD_PROVEEDOR";
                 ...
                 consulta += " LEFT OUTER JOIN UNIDADES_MEDIDA um ON iad.COD_UNIDAD_MEDIDA = um.COD_UNIDAD_MEDIDA";
                 ...
                 consulta += " WHERE ia.COD_ESTADO_INGRESO_ALMACEN<>2 and m.nombre_material like ? ";
                ...
                if (!nroIngreso.equals("") && !nroIngreso.equals("0")) {
                    consulta = consulta + " and ia.NRO_INGRESO_ALMACEN = '" + nroIngreso + "' ";
                }
                if (!nroOrdenCompra.equals("") && !nroOrdenCompra.equals("0")) {
                    consulta = consulta + " and oc.NRO_ORDEN_COMPRA = '" + nroOrdenCompra + "' ";
                }
                ...
                if (!codGrupo.equals("") && !codGrupo.equals("0")) {
                 ...
                 consulta += " ORDER BY ia.NRO_INGRESO_ALMACEN DESC";
               // consulta = consulta + " order by ia.FECHA_INGRESO_ALMACEN desc ";
                ...
                while (rs.next()) {
                    ...
                    out.print("<td HEIGHT='30PX' class='border' align='left'  style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding:5PX;' >" + (rs.getString("NOMBRE_MATERIAL") == null ? "" : rs.getString("NOMBRE_MATERIAL")) + "</td>");
                    out.print("<td HEIGHT='30PX' class='border' align='center'  style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;' >" + (rs.getString("ABREVIATURA") == null ? "" : rs.getString("ABREVIATURA")) + "</td>");
                    out.print("<th HEIGHT='30PX' class='border' align='right'  style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;' >" + (rs.getString("CANT_TOTAL_INGRESO_FISICO") == null ? "" : (formato.format(rs.getDouble("CANT_TOTAL_INGRESO_FISICO")))) + "</th>");
                    out.print("<td ALIGN='RIGHT' style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("PRECIO_UNITARIO_MATERIAL"))) + "</td>");
                    out.print("<th ALIGN='RIGHT' style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("PRECIO_TOTAL_MATERIAL"))) + "</th>");
                    out.print("<td ALIGN='RIGHT' style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("COSTO_UNITARIO"))) + "</td>");
                    out.print("<th ALIGN='RIGHT' style='border-bottom : solid #D8D8D8 1px;border-right : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("PRECIO_NETO"))) + "</th>");
