            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <td  class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center"><b>Unid.</b></td>
                     <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Nro. Salida</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Fecha Salida</b></td>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " p.NOMBRE_PROVEEDOR,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_UNITARIO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO"
                        + ",u.ABREVIATURA "
                        + " ,salidas.NRO_SALIDA_ALMACEN,salidas.FECHA_SALIDA_ALMACEN, salidas.COD_SALIDA_ALMACEN"
                        +" ,cambio_estado.FECHA_CAMBIO_ESTADO_MATERIAL, cambio_estado.NOMBRE_ESTADO_MATERIAL" +
                        ...
                        " left outer join ("
							+" select sadi.COD_INGRESO_ALMACEN, sadi.COD_MATERIAL, sa.FECHA_SALIDA_ALMACEN,sa.COD_SALIDA_ALMACEN, sa.NRO_SALIDA_ALMACEN "
							+" from SALIDAS_ALMACEN_DETALLE_INGRESO sadi"
							+" inner join SALIDAS_ALMACEN sa on sadi.COD_SALIDA_ALMACEN=sa.COD_SALIDA_ALMACEN"
							+" where sa.COD_ESTADO_SALIDA_ALMACEN=1 and sa.COD_AREA_EMPRESA=40 "
							+" group by sadi.COD_INGRESO_ALMACEN, sadi.COD_MATERIAL, sa.FECHA_SALIDA_ALMACEN,sa.COD_SALIDA_ALMACEN, sa.NRO_SALIDA_ALMACEN"
                         +" ) salidas on ia.COD_INGRESO_ALMACEN=salidas.COD_INGRESO_ALMACEN and iad.COD_MATERIAL=salidas.COD_MATERIAL"
                        + " left join ("
							+" select COD_INGRESO_ALMACEN, COD_MATERIAL, em.NOMBRE_ESTADO_MATERIAL, iade.FECHA_CAMBIO_ESTADO_MATERIAL "
							+" from INGRESOS_ALMACEN_DETALLE_ESTADO iade"
							+" inner join ESTADOS_MATERIAL em"
							
							+" on iade.COD_ESTADO_MATERIAL=em.COD_ESTADO_MATERIAL"
							//+" where FECHA_CAMBIO_ESTADO_MATERIAL is not null"
							+" group by COD_INGRESO_ALMACEN, COD_MATERIAL, em.NOMBRE_ESTADO_MATERIAL, iade.FECHA_CAMBIO_ESTADO_MATERIAL"
                         +" )cambio_estado on ia.COD_INGRESO_ALMACEN=cambio_estado.COD_INGRESO_ALMACEN and iad.COD_MATERIAL=cambio_estado.COD_MATERIAL"
                ...
                while (rs.next()) {
                    ...
                    out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + (rs.getString("NRO_SALIDA_ALMACEN") == null ? "" : rs.getString("NRO_SALIDA_ALMACEN")) + "</td>");
                    Date fecha_salida=rs.getTimestamp("FECHA_SALIDA_ALMACEN");
                    String dato_salida="";
                    if(fecha_salida!=null){
                        dato_salida=format.format(rs.getDate("FECHA_SALIDA_ALMACEN")) + " &nbsp; " + format1.format(rs.getTimestamp("FECHA_SALIDA_ALMACEN").getTime());
                    }
                    out.print("<td  style='border : solid #D8D8D8 1px;padding-left:5PX;'    >" + dato_salida + "</td>");
