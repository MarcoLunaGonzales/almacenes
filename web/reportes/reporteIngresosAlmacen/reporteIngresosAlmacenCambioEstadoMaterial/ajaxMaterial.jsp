...
consulta = " select m.COD_MATERIAL, m.NOMBRE_MATERIAL, gr.COD_GRUPO, gr.NOMBRE_GRUPO, c.COD_CAPITULO, c.NOMBRE_CAPITULO  from MATERIALES m " +
        ...
        (codGrupo.equals("")?"":" and gr.COD_GRUPO in ("+codGrupo+")")+" order by m.NOMBRE_MATERIAL asc  "; //and m.MOVIMIENTO_ITEM="+movimiento+"

System.out.println("consulta Grupossssss"+consulta); 
Connection con=null;
