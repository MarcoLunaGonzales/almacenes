           ...
           try {
            ...
            rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                       ...
                       <td class="">::</td>
                       <td>
                            <input type="text"  name="nombreMaterial" style="width:350px" id="nombreMaterial" class="inputText">
                                </td>
                      <td>
                            <input type="button" onclick="buscarMaterial(form1)" value="buscar" class="outputText2" >
                       </td>
                ...
                <div style="overflow:auto;text-align:center;height:150px;width:65% " id="main">
                <div id="div_material">
            ...
            <center>
                ...
                <input type="button" class="outputText2"  value=" Reporte General" name="reporte" onclick="verReporteGeneral(form1,'reporteConsumoPromedioGeneral.jsp')" />
