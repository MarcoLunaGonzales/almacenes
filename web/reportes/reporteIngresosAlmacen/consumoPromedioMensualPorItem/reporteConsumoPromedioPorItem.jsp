...
<html>
    ...
    <body >
        <form>
            <h4 align="center">Reporte Consumo Promedio Mensual Por Item</h4>
        ...
        try {
            ...
            <%
                ...
                if (rs.next()) {
                    ...
                    String sql_delete = "delete from KARDEX_ITEM_MOVIMIENTO_BACO";
            ...
            <table class="outputText2" align="CENTER" width="100%">
                ...
                <%
                                    ...
                                    String sql_insert = "insert into KARDEX_ITEM_MOVIMIENTO_BACO(cod_reporte,cod_persona,TIPO,TIPO_INGRESO_SALIDA,CANTIDAD_INGRESO,CANTIDAD_SALIDA,SALDO,unidad_medida,PRODUCTO)";
                                    ...
                                    cod_reporte = cod_reporte + 1;
                                            ...
                                            //String fechaFinalf =resultado.getYear()  + "/" + resultado.getMonth() + "/" + resultado.getDate();
                                            SimpleDateFormat sdf=new SimpleDateFormat("yyyy/MM/dd");
                                            String fechaFinalf=arrayfecha2[2]+"/"+arrayfecha2[1]+"/"+arrayfecha2[0];// sdf.format(resultado);
                                String consulta2="select( ISNULL((SELECT sum(iad.cant_total_ingreso_fisico)as ingresos_total_anterior FROM ingresos_almacen_detalle iad,ingresos_almacen ia where iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.cod_estado_ingreso_almacen=1 and ia.estado_sistema=1 and iad.cod_material='"+codMaterialKardex+"' and ia.cod_almacen= '"+codAlmacen+"'  and ia.fecha_ingreso_almacen<'"+fechaFinalf+" 23:59:00' ),0)-"+
                                                 "ISNULL((select sum(sad.cantidad_salida_almacen)as salidas_total_anterior from salidas_almacen_detalle sad,salidas_almacen sa where sad.cod_salida_almacen=sa.cod_salida_almacen and sa.cod_estado_salida_almacen=1 and sa.estado_sistema=1 and sad.cod_material='"+codMaterialKardex+"' and sa.cod_almacen= '"+codAlmacen+"'  and sa.fecha_salida_almacen<='"+fechaFinalf+" 23:59:00'),0)) as cant";
                ...
                <tr>
                    ...
                    <td style="border-bottom:SOLID 1PX #CCCCCC;"><b>&nbsp;</b></td>
                        ...
                        <%
                                ...
                                String sql_reporte = "select DISTINCT k.TIPO_INGRESO_SALIDA from KARDEX_ITEM_MOVIMIENTO_BACO k where k.COD_PERSONA="+codigoPersonal+" ";
                                ...
                                while (rs_reporte.next()) {
                                    ...
                                    formato.applyPattern("###0.00");
                                    for (int i = 1; i < 13; i++) {
                                        String sql_reporte1 = "select isnull(k.CANTIDAD_SALIDA,0),isnull(k.TIPO,0)  from KARDEX_ITEM_MOVIMIENTO_BACO k where k.COD_PERSONA="+codigoPersonal+"" +
