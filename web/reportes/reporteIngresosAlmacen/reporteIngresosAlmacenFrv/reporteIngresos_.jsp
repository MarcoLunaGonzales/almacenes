        ...
        <form>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " p.NOMBRE_PROVEEDOR proveedor_1,iad.CANT_TOTAL_INGRESO_FISICO,iad.COSTO_UNITARIO,g.NOMBRE_GRUPO,c.NOMBRE_CAPITULO,u.ABREVIATURA," +
                        " (select top 1 p.NOMBRE_PROVEEDOR from devoluciones d inner join SALIDAS_ALMACEN s on s.COD_SALIDA_ALMACEN = d.COD_SALIDA_ALMACEN "+
                        " inner join SALIDAS_ALMACEN_DETALLE_INGRESO sadi on sadi.COD_SALIDA_ALMACEN = s.COD_SALIDA_ALMACEN " +
                        " inner join INGRESOS_ALMACEN_DETALLE_ESTADO iade on iade.COD_INGRESO_ALMACEN = sadi.COD_INGRESO_ALMACEN " +
                        " and iade.COD_MATERIAL = sadi.COD_MATERIAL and iade.ETIQUETA = sadi.ETIQUETA and iade.cod_material = m.cod_material "+
                        " inner join INGRESOS_ALMACEN i on i.COD_INGRESO_ALMACEN = iade.COD_INGRESO_ALMACEN "+
                        " inner join ORDENES_COMPRA o on o.COD_ORDEN_COMPRA = i.COD_ORDEN_COMPRA inner join PROVEEDORES p on p.COD_PROVEEDOR = o.COD_PROVEEDOR) nombre_proveedor"+
