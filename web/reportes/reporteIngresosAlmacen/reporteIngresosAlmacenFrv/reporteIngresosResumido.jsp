...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos Resumido</h4>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        consulta = consulta + " order by m.NOMBRE_MATERIAL,"+
                                             "(case when t.COD_TIPO_INGRESO_ALMACEN=7 then"+
                        "( select top 1 p1.NOMBRE_PROVEEDOR"+
                        " from SALIDAS_ALMACEN s"+
                        " inner join SALIDAS_ALMACEN_DETALLE_INGRESO sadi on"+
                ...
                costoTotal = 0;
                String cabecera="";
                double sumaProovedor=0;
                String nombreMaterial="";
                String nombreGrupo1="";
                String nombreCapitulo1="";
                String nombreProovedor1="";
                String unidad="";
                while (res.next()) {
                    
                                if(!cabecera.equals(res.getString("NOMBRE_MATERIAL")+' '+res.getString("proveedor_devolucion")))
                                    {
                                            if(!cabecera.equals(""))
                                                {
                                                    out.print("<tr>");

                                                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+nombreMaterial+"</td>");
                                                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;' class='border'   >"+nombreProovedor1+"</td>");
                                                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+nombreCapitulo1+"</td>");
                                                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+nombreGrupo1+"</td>");
                                                    out.print("<td style='border : solid #D8D8D8 1px;padding-left:5PX;'  >"+unidad+"</td>");
                                                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(sumaProovedor))+"</td>");
                                                    out.print("</tr>");
                                            }
                                            cabecera=res.getString("NOMBRE_MATERIAL")+' '+res.getString("proveedor_devolucion");
                                            nombreProovedor1=(res.getString("proveedor_devolucion")==null?"":res.getString("proveedor_devolucion"));
                                            nombreCapitulo1=(res.getString("NOMBRE_CAPITULO")==null?"":res.getString("NOMBRE_CAPITULO"));
                                            nombreGrupo1=(res.getString("NOMBRE_GRUPO")==null?"":res.getString("NOMBRE_GRUPO"));
                                            unidad=(res.getString("ABREVIATURA")==null?"":res.getString("ABREVIATURA"));
                                            sumaProovedor=0;
                                            nombreMaterial=(res.getString("NOMBRE_MATERIAL")==null?"":res.getString("NOMBRE_MATERIAL"));
                                }
                                sumaProovedor+=res.getDouble("CANT_TOTAL_INGRESO_FISICO");
                  }
                if(!cabecera.equals(""))
                                                {
                                                    out.print("<tr>");
