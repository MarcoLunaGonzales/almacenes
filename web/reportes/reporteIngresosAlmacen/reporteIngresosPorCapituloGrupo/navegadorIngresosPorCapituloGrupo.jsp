...
<html>
    ...
    <body>
        <h3 align="center">Reporte de Ingresos Por Capítulo y Grupo </h3>
               ...
               try {
                ...
                ResultSet rs = st.executeQuery(sql);
                        ...
                        <tr>
                            ...
                            <td class="">::</td>
                            <td class="">
                                <input type="text" class="inputText" size="57" id="numIngreso" name="numIngreso" />
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                <input type="button" class="btn"  value="Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteIngresosPorCapituloGrupo.jsp')" />
