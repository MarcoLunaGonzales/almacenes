            ...
            <h4 align="center">Reporte de Ingresos Por Capítulo y Grupo</h4>
                ...
                /*
                       ...
                       /* NumberFormat numeroformato = NumberFormat.getNumberInstance(Locale.ENGLISH);
                        ...
                        System.out.println("numIngresoP :"+numIngresoP);
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String sqlCapitulo = " select DISTINCT C.NOMBRE_CAPITULO,C.COD_CAPITULO,G.NOMBRE_GRUPO,G.COD_GRUPO" +
                        ...
                        if(!codTipoIngresoAlmacen.equals("") && !codTipoIngresoAlmacen.equals("0")){
                            sqlCapitulo = sqlCapitulo +" and ia.COD_TIPO_INGRESO_ALMACEN in ("+codTipoIngresoAlmacen+") ";
                        }
                        ...
                        if(!numIngresoP.equals("") ){
                            ...
                            System.out.println("ENTROOOOO NRO ING :"+sqlCapitulo);
                        }
                ...
                con=Util.openConnection(con);
                PreparedStatement pst = con.prepareStatement(sqlCapitulo);
                pst.setString(1,nombreMaterialP+"%");System.out.println(" p1:"+nombreMaterialP );
                ResultSet rsCapitulo = pst.executeQuery();
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        //if(!codCapituloP.equals("") && !codCapituloP.equals("0")){
                            consulta = consulta +" and c.COD_CAPITULO in ("+codCapituloP+") ";
                        //}
                        //if(!codGrupoP.equals("") && !codGrupoP.equals("0")){
                            consulta = consulta +" and g.COD_GRUPO in ("+codGrupoP+") ";
                        //}
                        System.out.println("numIngresoP :::"+numIngresoP);
                        if(!numIngresoP.equals("") ){
                            consulta = consulta +" and ia.nro_ingreso_almacen in ("+numIngresoP+") ";
                        }
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("COSTO_UNITARIO")))+"</td>");
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("CANT_TOTAL_INGRESO_FISICO")*rs.getDouble("COSTO_UNITARIO")))+"</td>");
                                out.print("</tr>");
