...
<html>
    ...
    <body>
        <h3 align="center">REPORTE DE EXISTENCIAS POR FECHAS VALORADO</h3>
               ...
               try {
                ...
                ResultSet rs = st.executeQuery(sql);
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                <input type="button" class="btn"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteCostoProduccion.jsp')" />
                            </td>
                        </tr>
                    </tfoot>
                </table>
