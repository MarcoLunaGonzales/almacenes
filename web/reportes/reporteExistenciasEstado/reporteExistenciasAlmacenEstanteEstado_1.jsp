        ...
        try {
            ...
            <table width="70%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                while (rs_mat.next()) {
                    ...
                    consulta = " select ISNULL(sum(id.CANTIDAD_RESTANTE), 0) cantidad_r,isnull(E.NOMBRE_ESTANTE,'') NOMBRE_ESTANTE,isnull(amb.nombre_ambiente,'') nombre_ambiente,isnull(ID.FILA,'') FILA,isnull(ID.COLUMNA,'') COLUMNA" +
                             ...
                             " left outer join ambiente_almacen amb on amb.cod_ambiente = e.cod_ambiente " +
                             " where id.COD_MATERIAL = '"+rs_mat.getString("cod_material")+"' and id.CANTIDAD_RESTANTE > 0" +
                             " and id.COD_ESTADO_MATERIAL = '"+estadoMaterial+"' and i.COD_ALMACEN = '"+codAlmacen+"'" +
                             " GROUP BY amb.nombre_ambiente,E.NOMBRE_ESTANTE,ID.FILA,ID.COLUMNA ";
                    ...
                    while(res.next())
                    {
                        ...
                        out.print("<td  align='right' style='border : solid #D8D8D8 1px;PADDING:8PX' class='border'   >&nbsp;" + formato.format(cantidad) + "</td></tr>");
                    }
