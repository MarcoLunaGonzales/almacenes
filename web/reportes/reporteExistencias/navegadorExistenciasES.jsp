...
<html>
    ...
    <body>
        <h3 align="center">REPORTE DE EXISTENCIAS ALMACEN QUINTANILLA VS TRANSITORIO</h3>
               ...
               try {
                ...
                ResultSet rs = st.executeQuery(sql);
                            ...
                            <td style="padding:8px">
                                <select style='color:fuchsia' id="codFilial"  onchange="ajaxAlmacen(form1);" disabled="true">
                                    <%
                            ...
                            <td style="padding:8px">
                                ...
                                %>
                                <select style='color:fuchsia' id="codAlmacen" class="inputText" disabled="true">
                        ...
                        <tr  >
                            ...
                            %>
                            <td style="padding:8px">
                                <select id="codCapitulo" multiple size="10"  onchange="ajaxGrupo(form1);">
                                    <%
                        ...
                        <tr >
                            ...
                            <td style="padding:8px" style="padding:8px">
                                <input type="button" class="btn"   onclick="buscarMaterial(form1)" value="Buscar"></input>
                            </td>
                        </tr>
                        <tr >
                           ...
                           <input type="text"  size="12"  value="<%=form.format(new Date()) %>" id="fecha" class="inputText">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                <input type="button" class="btn"  value="Ver Reporte ES con Detalle de última salida" name="reporte" onclick="verReporte(form1,'reporteExistenciasAlmacenQT_ES.jsp')" />
                            </td>
                        </tr>
                    </tfoot>
                </table>
