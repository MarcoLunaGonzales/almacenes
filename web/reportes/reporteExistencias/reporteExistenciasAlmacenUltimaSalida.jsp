        ...
        HASTA <%= arrayhasta[0] +"/"+ arrayhasta[1]+"/"+arrayhasta[2] %>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr bgcolor="#cccccc">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Reanalisis</b></td>
...
<td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Nro. Últ. Salida</b></td>
<td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" width="150px"><b>Fecha salida</b></td>
<td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Lote Producción</b></td>
<td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Cantidad Salida</b></td>
                ...
                <%
                    ...
                    String consulta = " select m.cod_material,m.CODIGO_ANTIGUO,m.nombre_material,um.abreviatura,m.stock_minimo_material,m.stock_maximo_material,m.stock_seguridad, "
                            ...
                            + " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia "
                            + " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen "
                            + " and ia.cod_almacen=" + codAlmacen + " and iade.cod_estado_material=5 and ia.fecha_ingreso_almacen<='" + fecha + " 23:59:59' and iade.cantidad_restante>0)as reanalisis, "
                            + " (select SUM(iade.cantidad_restante) from ingresos_almacen_detalle_estado iade,ingresos_almacen_detalle  iad,ingresos_almacen ia "
                            + " WHERE iade.cod_material=m.cod_material and ia.cod_estado_ingreso_almacen=1 and iad.cod_ingreso_almacen=ia.cod_ingreso_almacen and ia.estado_sistema=1 and iade.cod_material=iad.cod_material and iade.cod_ingreso_almacen=iad.cod_ingreso_almacen "
       ...
       +" ,salidas.CANTIDAD_SALIDA_ALMACEN"
                    ...
                    while (rs.next()) {
                        ...
                        if (sw == 1) {
                            ...
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px'class='border'   >" + formato.format(aprobados) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px'class='border'   >" + formato.format(rs.getDouble("cuarentena")) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px'class='border'   >" + formato.format(rs.getDouble("rechazado")) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px' >" + formato.format(rs.getDouble("reanalisis")) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px' >" + formato.format(rs.getDouble("vencido")) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px' >" + formato.format(rs.getDouble("observado")) + "</td>");
                            out.print("<td align='right'style='border-bottom:1px solid #cccccc;padding:8px' >" + formato.format(aprobados + rs.getDouble("cuarentena")) + "</td>");
