        ...
        */
          ...
          function ajaxAlmacen(f){
            ...
            function verReporte(){
                        ...
                        form1.action="reporteSalidasSinCostoActualizado.jsf";
       ...
       <form method="post" action="reporteResumenDevoluciones.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                         <td style="padding:8px">Tipo de salida</td>
                        <td style="padding:8px">::</td>

                        <td style="padding:8px">
                            <div id="div_tipo_salidas">
                            <%
                            sql_almacenes="select tsa.COD_TIPO_SALIDA_ALMACEN,tsa.NOMBRE_TIPO_SALIDA_ALMACEN from TIPOS_SALIDAS_ALMACEN tsa where tsa.COD_ESTADO_REGISTRO=1 order by tsa.NOMBRE_TIPO_SALIDA_ALMACEN asc";
                            rs_a = st_a.executeQuery(sql_almacenes);
                            %>
                            <select  name="codTipoSalida" class="inputText" >
                                <option value="-1" selected>-TODOS-</option>
                                <%
                                while (rs_a.next()) {

                                    out.print("<option value="+ rs_a.getString("COD_TIPO_SALIDA_ALMACEN") +" >"+rs_a.getString("NOMBRE_TIPO_SALIDA_ALMACEN")+"</option>");
                        ...
                        <td style="padding:8px">
                            <div id="div_producto">
                            <%
                            sql_almacenes="select cp.COD_COMPPROD,cp.nombre_prod_semiterminado from COMPONENTES_PROD cp order by cp.nombre_prod_semiterminado asc";
                            System.out.println("sql_productos" + sql_almacenes);
                            
                            rs_a = st_a.executeQuery(sql_almacenes);
                            %>
                            <select  name="codProducto" class="inputText" style="width:310px">
                                <option value="-1" selected>-TODOS-</option>
                                <%
                                while (rs_a.next()) {
                                
                                    out.print("<option value="+ rs_a.getString("COD_COMPPROD") +" >"+rs_a.getString("nombre_prod_semiterminado")+"</option>");
                    ...
                    <tr class="outputText3">
                         <td>N° de Salida</td>
                            <td>::</td>
                            <td>
                        <input type="text" name="nroSalida" value="">
                            </td>
                            <td>N° de Lote</td>
                            <td>::</td>
                            <td>
                        <input type="text" name="nroLote" value="">
                            </td>
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select name="codAreaDestino" class="outputText3" style="width:310px">
                                <%
