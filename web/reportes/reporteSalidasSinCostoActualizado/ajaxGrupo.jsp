package reportes.reporteDevolucionesSinCostoActualizado_1;

package reportes.reporteResumenSalidasDevoluciones_1;

package reportes.reporteResumenSalidasDevoluciones;
...
out.println("<select name='codGrupo' size='10' class='inputText' style='width:200px' >");
while(rs.next()){
