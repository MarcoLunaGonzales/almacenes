        ...
        <body >
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <%--inicio alejandro buscador--%>
                    <a4j:commandButton value="Generar Devolción" onclick="Richfaces.showModalPanel('panelBuscarSalidaAlmacen')" styleClass="btn" />
                    <%--final alejandro buscador--%>
             ...
             <rich:modalPanel id="panelBuscarSalidaAlmacen" minHeight="400"  minWidth="700"
                        ...
                        <h:panelGroup id="contenidoBuscarSalidaAlmacen">
                            ...
                            <h:panelGrid columns="8">
                                ...
                                <h:inputText value="#{ManagedDevolucionAlmacen.salidasAlmacenBuscar.codLoteProduccion}" id="nroLote" styleClass="inputText" size="5" onkeypress="valNum(event);" />
             ...
             <rich:modalPanel id="panelBuscarDevolucion"  minHeight="300"  minWidth="1000"
                        ...
                        <h:panelGroup id="contenidoBuscarDevolucion">
                            <h:panelGrid columns="4">
                                ...
                                <h:outputText value="Nro Lote:" styleClass="outputText1" />
                                <h:inputText value="#{ManagedDevolucionAlmacen.buscarDevolucion.salidasAlmacen.codLoteProduccion}" styleClass="inputText" size="5" onkeypress="valNum(event);" />
