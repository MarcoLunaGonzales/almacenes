...
String agenciaVenta = "";
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    ...
                    <%=((codTipoIngresoAlmacen.equals("")||codTipoIngresoAlmacen.contains("6"))?"<td  style='border : solid #D8D8D8 1px' class='border'  bgcolor='#f2f2f2'  align='center'><b>Lote de Devolución</b></td>":"")%>
