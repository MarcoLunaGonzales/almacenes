package reportes.reporteDevolucionesAlmacen.reporteIngresosPorCapituloGrupo;

package reportes.reporteIngresosAlmacen_1.reporteIngresosPorCapituloGrupo;
...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos Por Capítulo y Grupo</h4>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                String sqlCapitulo = " select DISTINCT C.NOMBRE_CAPITULO,C.COD_CAPITULO,G.NOMBRE_GRUPO,G.COD_GRUPO" +
                        ...
                        if(!nombreMaterialP.equals("") ){
                            sqlCapitulo = sqlCapitulo + " and m.nombre_material like '"+nombreMaterialP+"%' " ;
                        }
                        if(!codFilial.equals("") && !codFilial.equals("0")){
                            sqlCapitulo = sqlCapitulo + " and f.cod_filial = '"+codFilial+"' " ;
                        }
                        if(!codAlmacen.equals("") && !codAlmacen.equals("0")){
                            sqlCapitulo = sqlCapitulo + " and ia.COD_ALMACEN = '"+codAlmacen+"' " ;
                        }
                        if(!fechaInicial.equals("") && !fechaFinal.equals("")){
                            sqlCapitulo = sqlCapitulo + " and ia.FECHA_INGRESO_ALMACEN between '"+fechaInicial+" 00:00:00' and '"+fechaFinal+" 23:59:59' ";
                        }
                        if(!codProveedor.equals("") && !codProveedor.equals("0")){
                            sqlCapitulo = sqlCapitulo + " and ia.COD_PROVEEDOR = '"+codProveedor+"' ";
                        }
                        if(!codTipoIngresoAlmacen.equals("") && !codTipoIngresoAlmacen.equals("0")){
                            sqlCapitulo = sqlCapitulo +" and ia.COD_TIPO_INGRESO_ALMACEN = '"+codTipoIngresoAlmacen+"' ";
                        }
                        if(!codCapitulo.equals("") && !codCapitulo.equals("0")){
                            sqlCapitulo = sqlCapitulo +" and c.COD_CAPITULO in ("+codCapitulo+") ";
                        }
                        if(!codGrupo.equals("") && !codGrupo.equals("0")){
                            sqlCapitulo = sqlCapitulo +" and g.COD_GRUPO in ("+codGrupo+") ";
                        }
                        if(!numIngresoP.equals("") ){
                            sqlCapitulo = sqlCapitulo +" and ia.nro_ingreso_almacen in ("+numIngresoP+") ";
                        }

                        sqlCapitulo = sqlCapitulo + " ORDER BY C.NOMBRE_CAPITULO ,G.NOMBRE_GRUPO    ";



                System.out.println("sqlCapitulo "+ sqlCapitulo);

                con=Util.openConnection(con);
                Statement stCapitulo = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                ResultSet rsCapitulo = stCapitulo.executeQuery(sqlCapitulo);
                int codCapituloAux=0;
                int codGrupoAux=0;
                int c=0;
                while(rsCapitulo.next()){

                    String nomCapituloP=rsCapitulo.getString(1);
                    int codCapituloP=rsCapitulo.getInt(2);
                    String nomGrupoP=rsCapitulo.getString(3);
                    int codGrupoP=rsCapitulo.getInt(4);
                    if(c==0){
                        codCapituloAux=codCapituloP;
                        codGrupoAux=codGrupoP;
                        c++;
                        %>
                        <tr bgcolor="#cccccc" class="outputText2">
                            <td align="center" height="30px" colspan="12" ><%=nomCapituloP%> </td>
                        </tr>
                        <%
                    }else{
                        if(codCapituloAux!=codCapituloP){
                              %>
                            <tr bgcolor="#cccccc" class="outputText2">
                                <td align="center" height="30px" colspan="12"><%=nomCapituloP%> </td>
                            </tr>
                    ...
                    %>
                    <tr bgcolor="#f2f2f2" class="outputText2">
                        <td height="30px" > &nbsp;</td>
                        <td  colspan="11"> <%=nomGrupoP%></td>
                    </tr>
                    <tr class="">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Importe Neto</b></td>
                ...
                String consulta = " select m.COD_MATERIAL,m.NOMBRE_MATERIAL,u.ABREVIATURA,ia.COD_INGRESO_ALMACEN,ia.NRO_INGRESO_ALMACEN," +
                        ...
                        " iad.PRECIO_TOTAL_MATERIAL,iad.PRECIO_NETO " +
                        " from INGRESOS_ALMACEN ia " +
                        " inner join TIPOS_INGRESO_ALMACEN t on ia.COD_TIPO_INGRESO_ALMACEN = t.COD_TIPO_INGRESO_ALMACEN " +
                        " inner join PROVEEDORES p on p.COD_PROVEEDOR = ia.COD_PROVEEDOR " +
                        " inner join INGRESOS_ALMACEN_DETALLE iad on iad.COD_INGRESO_ALMACEN = ia.COD_INGRESO_ALMACEN " +
                        ...
                        " left outer join ORDENES_COMPRA oc on oc.COD_ORDEN_COMPRA = ia.COD_ORDEN_COMPRA " +
                        " where ia.COD_ESTADO_INGRESO_ALMACEN<>2 and 0=0 ";
                        consulta = consulta +" and c.COD_CAPITULO in ("+codCapituloP+") ";
                        consulta = consulta +" and g.COD_GRUPO in ("+codGrupoP+") ";
                        ...
                        if(!numIngresoP.equals("") || !numIngresoP.equals("0")){
                            sqlCapitulo = sqlCapitulo +" and ia.nro_ingreso_almacen in ("+numIngresoP+") ";
                        }
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("PRECIO_TOTAL_MATERIAL")))+"</td>");
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(rs.getDouble("PRECIO_NETO")))+"</td>");
                                out.print("</tr>");
                                costoTotal = costoTotal + rs.getDouble("CANT_TOTAL_INGRESO_FISICO") ;
                                costoTotalPrecio = costoTotalPrecio + rs.getDouble("PRECIO_TOTAL_MATERIAL") ;
                                costoNeto = costoNeto + rs.getDouble("PRECIO_NETO") ;
                  }
                                ...
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(costoTotalPrecio))+"</td>");
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(costoNeto))+"</td>");
                                out.print("</tr>");
                                codCapituloAux=codCapituloP;
                                codGrupoAux=codGrupoP;
}
