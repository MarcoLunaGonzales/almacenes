...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte de Ingresos Por Item Valorado</h4>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                while (rs.next()) {
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td align='right' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format( rs.getDouble("COSTO_UNITARIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO")))+"</td>");
                                out.print("</tr>");

                                costoTotal = costoTotal + rs.getDouble("COSTO_UNITARIO") * rs.getDouble("CANT_TOTAL_INGRESO_FISICO");
                                cantTotal = cantTotal + rs.getDouble("CANT_TOTAL_INGRESO_FISICO") ;
                  }
                                out.print("<tr>");
                                out.print("<td HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;padding-right:5PX;' colspan = '9'  >TOTAL</td>");

                               
                                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >"+(formato.format(cantTotal))+"</td>");
