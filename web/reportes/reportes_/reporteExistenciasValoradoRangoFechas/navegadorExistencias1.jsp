...
<html>
    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
            <div align="center">
                <table  cellpadding="9" class="border" width="50%">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <input type="text"  size="12"  value="<%=form.format(new Date()) %>" name="fecha" class="inputText">
                        ...
                        <input type="text"  size="12"  value="<%=form1.format(new Date()) %>" name="fechaF" class="inputText">
                            <img id="imagenFecha2" src="../../img/fecha.bmp">
                            <DLCALENDAR tool_tip="Seleccione la Fecha"
                                        daybar_style="background-color: DBE1E7;
                                        font-family: verdana; color:000000;"navbar_style="background-color: 7992B7; color:ffffff;"
                                        input_element_id="fechaF" click_element_id="imagenFecha2">
                             </DLCALENDAR>
                    ...
                    <tr  class="outputText3">
                        ...
                        <td style="padding:8px" style="padding:8px">
                            <select name="movimiento" class="outputText3">
                ...
                <div style="overflow:auto;text-align:center;height:150px;width:80% " id="main">
                <div id="div_material">
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteExistenciasAlmacen.jsp')" />
