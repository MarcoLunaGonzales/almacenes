        ...
        */
          ...
          function ajaxAlmacen(f){
            ...
            function verReporte(f,nombreReporte){
                ...
                f.codTipoSalida.value = arrayCodTipoSalidaAlmacen;
    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            <br>
            <center>
                <input type="button" class="btn"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteExistenciasAlmacen.jsp')"/><%-- onclick="verReporte(form1,'reporteExistenciasAlmacen.jsp')" --%>
