package reportes.reporteSalidasAlmacen.reporteSalidasAlmacen;
...
<html>
        ...
        */
         ...
         function valTipo(f){
          ...
          function ajaxAlmacenDestino(f){
                ...
                ajax.open("GET","ajaxAlmacenDestino.jsf?codFilial="+(f.codFilial.value),true);
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
                        div_almacen.innerHTML=ajax.responseText;
                    }
    ...
    <body>
        <h3 align="center">Reporte de Salidas</h3>
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select style="color:blue;text-transform:uppercase" name="codFilial" class="outputText3" onchange="ajaxAlmacen(form1);">
                                <%
                    ...
                    <tr class="outputText3" >
                        ...
                        %>
                        <td class="">
                            <select style="color:blue;text-transform:uppercase" name="codCapitulo" multiple size="10"  class="outputText3" onchange="ajaxGrupo(form1);">
                                <%
                        ...
                        <td class="">
                            <div id="div_grupo">
                                <select style="color:blue;text-transform:uppercase" name="codGrupo" class="inputText" size="10" style="width:200px;" >
                                <option value="-1">-TODOS-</option>
                            </select>
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select name="codProveedor" style="color:blue;text-transform:uppercase" class="outputText3" style="width:350px">
                        ...
                        %>
                            ...
                            <select name="codTipoSalidaAlmacen" style="color:blue;text-transform:uppercase" onchange="valTipo(this.form);" class="outputText3" >
                                <option value="0" >-TODOS-</option>
                                <%
                            while (rs.next()) {
                    ...
                    <tr class="outputText3">
                        <td height="35px" class="">Filial Destino</td>
                        <td class="">::</td>
                        <%
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                        %>
                        <td class="">
                            <select style="color:blue;text-transform:uppercase" disabled="true" name="codFilialDestino" class="outputText3" onchange="ajaxAlmacenDestino(form1);">
                                <%
                        ...
                        <td class="">Almacen Destino</td>
                        <td class="">::</td>

                        <td class="">
                            <div id="div_almacen">
                            <select name="codAlmacenDestino" class="inputText" >
                                <option value="-1">-TODOS-</option>
                            </select>
                            </div>
                        </td>
                     ...
                     <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <input type="text" style="color:blue;text-transform:uppercase" size="12"  value="<%=form.format(new Date()) %>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                           <td class="">
                             <input type="text" style="color:blue;text-transform:uppercase" size="12"  value="<%=form.format(new Date()) %>" name="fecha2" class="inputText">
                     ...
                     <tr class="outputText3">
                       ...
                       <td  height="35px" class="">Nro de Salida</td>
                        <td class="">::</td>
                        <td class="">
                                <input type="text" style="color:blue;text-transform:uppercase" onkeypress="valNum(event);" class="inputText" size="20" name="numLote" />
                        </td>
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteSalidasAlmacen.jsp')" />
