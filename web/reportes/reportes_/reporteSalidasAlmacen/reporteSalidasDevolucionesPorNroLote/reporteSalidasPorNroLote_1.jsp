package reportes.reporteSalidasAlmacen.reporteSalidasDevolucionesPorNroLote;
    ...
    <body>
        ...
        try {
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="">
                    <td HEIGHT='25PX' class="border" style="border : solid #D8D8D8 1px" bgcolor="#f2f2f2"  align="center" colspan="8" ><b>&nbsp;</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" colspan="3"><b>SALIDAS</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" colspan="3"><b>DEVOLUCIONES</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center" colspan="1"><b>&nbsp;</b></td>
                ...
                <tr class="">
                    ...
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Costo Unit.</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Costo Total</b></td>
                    <td  style="border : solid #D8D8D8 1px" class="border"  bgcolor="#f2f2f2"  align="center"><b>Cant. Neta</b></td>
                </tr>
                ...
                while (rs.next()) {
                    if (c == 0) {
                        ...
                        if (nroSalidaAux != rs.getInt("NRO_SALIDA_ALMACEN")) {
                            ...
                            out.print("<th HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;' colspan = '8'  >TOTAL&nbsp;</th>");
                            ...
                            out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                            out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                            out.print("<th ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;font-family:monospace;font-size:small'  >" + (formato.format(costoTotalDevolucion)) + "</th>");
                            out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                            out.print("</tr>");
                            costoTotal = 0;
                            costoTotalCosto = 0;
                    ...
                    devoluciones += " and ia.cod_estado_ingreso_almacen=1 and d.cod_estado_devolucion=1 order by  ia.fecha_ingreso_almacen desc";
                    ...
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("cantidad_salida_almacen"))) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (redondear(rs.getDouble("costo_salida"), 2)) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("total_salida"))) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(cantDev)) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (redondear(costoUnitDev, 2)) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(costoTotalDev)) + "</td>");
                    out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >" + (formato.format(rs.getDouble("cantidad_salida_almacen")-cantDev)) + "</td>");
                ...
                out.print("<th HEIGHT='30PX' ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-left:5PX;' colspan = '8'  >TOTAL GENERAL&nbsp;</th>");
                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                out.print("<th ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;font-family:monospace;font-size:small'  >" + (formato.format(totalSalidas)) + "</th>");
                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                out.print("<th ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;font-family:monospace;font-size:small'  >" + (formato.format(totalDevolucion)) + "</th>");
                out.print("<td ALIGN='RIGHT' style='border : solid #D8D8D8 1px;padding-right:5PX;'  >&nbsp;</td>");
                out.print("</tr>");
