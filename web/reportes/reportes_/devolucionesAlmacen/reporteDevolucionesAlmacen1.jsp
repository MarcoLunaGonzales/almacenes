        ...
        <form target="_blank" id="form" name="form">
            ...
            <br>
                <%
                  ...
                  String consulta = "  select d.COD_DEVOLUCION,d.NRO_DEVOLUCION,i.nro_ingreso_almacen,i.FECHA_INGRESO_ALMACEN,cp.COD_COMPPROD,cp.nombre_prod_semiterminado,s.COD_SALIDA_ALMACEN,s.NRO_SALIDA_ALMACEN,s.COD_LOTE_PRODUCCION, " +
                          ...
                          " where d.COD_DEVOLUCION = '"+ ingresosAlmacen.getDevoluciones().getCodDevolucion()+"' and i.COD_ALMACEN = '"+managedAccesoSistema.getAlmacenesGlobal().getCodAlmacen()+"' ";
            ...
            <table  align="center" width="90%" class="outputText2" style="border : solid #f2f2f2 1px;" cellpadding="0" cellspacing="0">
                ...
                consulta = "  select m.CODIGO_ANTIGUO,m.cod_material,m.NOMBRE_MATERIAL,dd.CANTIDAD_DEVUELTA,u.cod_unidad_medida,u.ABREVIATURA " +
                         " from DEVOLUCIONES_DETALLE dd inner join materiales m on m.COD_MATERIAL = dd.COD_MATERIAL" +
                         " inner join UNIDADES_MEDIDA u on u.COD_UNIDAD_MEDIDA = dd.COD_UNIDAD_MEDIDA" +
                         " where dd.COD_DEVOLUCION = '"+ingresosAlmacen.getDevoluciones().getCodDevolucion()+"' order by m.NOMBRE_MATERIAL ";
