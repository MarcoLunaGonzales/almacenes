    ...
    <body>
        <form>
            ...
            <table width="70%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                System.out.println("consulta 1 "+ consulta.substring(0,2000) );
                System.out.println("consulta 1 "+ consulta.substring(2001,4000) );
                System.out.println("consulta 1 "+ consulta.substring(4001)); //,6000
                ...
                while (rs.next()) {
                    ...
                    //System.out.println("consulta 1 "+ consulta);
                                ...
                                out.print("<td align='right' style='border : solid #D8D8D8 1px'  >"+formato.format(aprobados)+"</td>");
                                out.print("</tr>");
                                }
                  }
