    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
                       ...
                       <tr class="outputText3">
                        ...
                        <td class="">
                           ...
                           try {
                            ...
                            String sql = " select p.cod_material,p.nombre_material from materiales p order by p.nombre_material";

                            System.out.println("sql material:" + sql);
                            ResultSet rs = st.executeQuery(sql);
                        %>

                            <select name="codMaterial"  class="outputText3" style="width:350px">
                                <option value="0" >-TODOS-</option>
                                <%
                            while (rs.next()) {
                                out.print("<option value="+ rs.getString("cod_material") +" >"+rs.getString("nombre_material")+"</option>");
                            }%>
                            </select>
                            <%
                            rs.close();
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value=" Reporte Por Item" name="reporte" onclick="verReporte(form1,'reporteConsumoPromedioPorItem.jsp')" />
                <input type="button" class="outputText2"  value=" Reporte General " name="reporte" onclick="verReporte(form1,'reporteConsumoPromedioGeneral.jsp')" />
                <input type="button" class="outputText2"  value="Reporte Por Lote" name="reporte" onclick="verReporte(form1,'reporteIngresosAlmacenPorItemLote.jsp')" />
                <input type="button" class="outputText2"  value="Reporte Por Lote Detallado" name="reporte" onclick="verReporte(form1,'reporteIngresosAlmacenPorItemLoteDetallado.jsp')" />
