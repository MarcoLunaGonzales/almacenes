        ...
        <body>
            <a4j:form id="form1">
                ...
                <div align="center">
                    ...
                    <a4j:commandButton value="Editar" action="#{ManagedMateriales.editarMaterial_action}" reRender="contenidoEditarMaterial" oncomplete="Richfaces.showModalPanel('panelEditarMaterial')" styleClass="btn"
                                       onclick="if(seleccionar('form1:dataMateriales')==false){return false;}"/>
                    <a4j:commandButton value="Eliminar" action="#{ManagedMateriales.eliminarMaterial_action}"
                                       reRender="dataMateriales" oncomplete="if(#{ManagedMateriales.mensaje!=''}){alert('#{ManagedMateriales.mensaje}')}"
                                       styleClass="btn" onclick="if(confirm('esta seguro de eliminar?')==false || seleccionar('form1:dataMateriales')==false){return false;}" />
                    ...
                    <h:panelGroup id="contenidoAgregarMaterial">
                        <div align="center">
                            ...
                            <h:panelGrid columns="4" headerClass="headerClassACliente" style="width:100%">
                                ...
                                <h:outputText value="Premio :" styleClass="outputText1" id="codPremioItem11"   />
                            ...
                            <a4j:commandButton styleClass="btn" value="Guardar"
                                               ...
                                               {if(#{ManagedMateriales.mensaje eq '5'}){alert('Se produjo un error al guardar el material. Consultar con Sistemas.')}else{alert('#{ManagedMateriales.mensaje}')}}"
                    ...
                    <h:panelGroup id="contenidoEditarMaterial">
                        <div align="center">
                            ...
                            <h:panelGrid columns="4" headerClass="headerClassACliente" style="width:100%">
                                ...
                                <h:outputText value="Premio :" styleClass="outputText1" id="codPremioItem1"   />
                            ...
                            <a4j:commandButton styleClass="btn" value="Guardar"
                                               ...
                                               reRender="dataMateriales" oncomplete="if(#{ManagedMateriales.mensaje eq '1'}){alert('Se guardo la edicion');Richfaces.hideModalPanel('panelEditarMaterial');}else
                                               {if(#{ManagedMateriales.mensaje eq 2}){alert('no se puede inactivar el material porque se esta usando en una formula maestra activa');verDetalleFormulasMaterial(#{ManagedMateriales.materiales.codMaterial})}else{alert('#{ManagedMateriales.mensaje}')}}"
                                               onclick="if(confirm('Esta seguro de guardar la informacion?')==false){return false;}" />
