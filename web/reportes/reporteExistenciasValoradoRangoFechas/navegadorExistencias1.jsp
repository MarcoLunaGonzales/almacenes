...
<html>
    ...
    <body>
        <h3 align="center">Reporte de Existencias Por Fechas</h3>
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <input type="text"  size="12"  value="<%=form1.format(new Date()) %>" id="fechaF" name="fechaF" class="inputText">
                        ...
                        <tr  class="outputText3">
                            ...
                            <td class="">::</td>
                            <td>
                            <select id="codStock" name="codStock" class="inputText"  >
                            ...
                            <select id="movimiento" name="movimiento" class="outputText3">
