...
<html>
    ...
    <%
        ...
        try {
            ...
            String reportFileName = application.getRealPath("/reportes/reporteSalidasAlmacen/reporteResumenGeneralLotesCantidades/reporteGeneralLotesCantidades_Ubicaciones.jasper");
