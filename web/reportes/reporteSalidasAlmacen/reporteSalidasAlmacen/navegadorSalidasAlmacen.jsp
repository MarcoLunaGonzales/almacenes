...
<html>
    <head>
        ...
        <script  type="text/javascript">
          ...
          function ajaxAlmacenDestino(f){
                ...
                ajax.onreadystatechange=function(){
                    if (ajax.readyState==4) {
                        document.getElementById("div_almacenDestino").innerHTML=ajax.responseText;
                        desBloquearPantalla();
                    }
                }
    ...
    function valTipo(f){
        if(f.codTipoSalidaAlmacen.value==3){
               ...
               try {
                ...
                ResultSet rs = st.executeQuery(sql);
                        ...
                        <tr  >
                            ...
                            %>
                            <td class="">
                                <select style="color:blue;text-transform:uppercase" id="codCapitulo" name="codCapitulo" multiple size="10"   onchange="ajaxGrupo(form1);">
                                    <%
                            ...
                            <td class="">
                                <div id="div_grupo">
                                    <select style="color:blue;text-transform:uppercase" id="codGrupo" name="codGrupo" class="inputText" size="10" style="width:200px;" >
                                    <option value="-1">-TODOS-</option>
                                </select>
    ...
    try{
                ...
                ResultSet rs = st.executeQuery(sql);
                            %>
                            <td class="">
                                <select style="color:blue;text-transform:uppercase" id="codAreaDestino" name="codAreaDestino" class="outputText3 chosen" >
                                    <%
                            ...
                            <select id="codTipoSalidaAlmacen" name="codTipoSalidaAlmacen" style="color:blue;text-transform:uppercase" onchange="valTipo(this.form);"  >
               ...
               try {
                ...
                ResultSet rs = st.executeQuery(sql);
                            %>
                            <td class="">
                                <select style="color:blue;text-transform:uppercase" disabled="true" id="codFilialDestino" name="codFilialDestino"  onchange="ajaxAlmacenDestino(form1);">
                                    <%
                            ...
                            <td class="">
                                <div id="div_almacenDestino">
                                <select id="codAlmacenDestino" name="codAlmacenDestino" class="inputText" >
                                    <option value="-1">-TODOS-</option>
                                </select>
                                </div>
                            </td>
                        ...
                        <tr >
                         ...
                         <tr >
                            ...
                            <td class="">
                                ...
                                <input type="text" style="color:blue;text-transform:uppercase" size="12"  value="<%=form.format(new Date()) %>" id="fecha1" name="fecha1" class="inputText">
                            ...
                            <td class="">::</td>
                            <td class="">
                                 <input type="text" style="color:blue;text-transform:uppercase" size="12"  value="<%=form.format(new Date()) %>" id="fecha2" name="fecha2" class="inputText">
                         ...
                         <tr >
                           ...
                           <td  height="35px" class="">Nro de Salida</td>
                            <td class="">::</td>
                            <td class="">
                                <input type="text" style="color:blue;text-transform:uppercase" onkeypress="valNum(event);" class="inputText" size="20" id="numSalidaAlmacen" name="numSalidaAlmacen" />
                            </td>
