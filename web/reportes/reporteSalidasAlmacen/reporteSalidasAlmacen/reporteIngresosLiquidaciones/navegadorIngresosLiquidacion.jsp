    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select name="codGestion"  class="outputText3" style="width:150px">
                        ...
                        <td class="">::</td>
                        <td class="">
                             <input type="text" class="inputText" size="17" name="nroIngreso" onkeypress="valNum(event)" />
                        </td>
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select name="codTipoCompra"  class="outputText3" style="width:150px">
                                <option value="0" >-TODOS-</option>
                                <%
                            while (rs.next()) {
                        ...
                        <td class="">::</td>
                        <td class="">
                             <input type="text" class="inputText" size="17" name="nroOrdenCompra" onkeypress="valNum(event)" />
                        </td>
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select name="codTipoIngresoAlmacen" multiple  class="outputText3" >
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <input type="text" disabled="true"  size="12"  value="<%=form.format(new Date()) %>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                           <td class="">
                             <input type="text" disabled="true"  size="12"  value="<%=form.format(new Date()) %>" name="fecha2" class="inputText">
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select name="codEstadoLiquidacion"  class="outputText3" style="width:150px">
                                <option value="0" >-TODOS-</option>
                                <%
                            while (rs.next()) {
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value=" Ver Reporte de Liquidaciones" name="reporte" onclick="verReporte(form1,'reporteIngresosLiquidacion.jsp')" />
                <input type="button" class="outputText2"  value=" Ver Reporte de Estados" name="reporte" onclick="verReporte(form1,'reporteIngresosLiquidacionEstado.jsp')" />
