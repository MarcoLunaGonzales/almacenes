...
<html>
    ...
    <body>
        <form>
            <h4 align="center">Reporte Res̼men General de Lotes</h4>
                        ...
                        if (!loteAnt.equals(codLoteProd)) {
                            ...
                            for (int j = 0; j < capVector.length; j++) {
                                ...
                                while (rs.next()) {
                                    ...
                                    String devoluciones = " select sum(isnull(iad.COSTO_UNITARIO * iad.CANT_TOTAL_INGRESO_FISICO, 0)) as total_salida";
