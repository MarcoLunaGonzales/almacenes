...
<html>
    <head>
        ...
        <script >
            ...
            function limpiar(f){
                //alert(f.codFilial.value);
                f.codFilial.value=-1;
                f.codAlmacen.value=-1;
         ...
         ManagedAccesoSistema bean1=(ManagedAccesoSistema)com.cofar.util.Util.getSessionBean("ManagedAccesoSistema");
           ...
           try {
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <input type="text"  size="12" style="color:fuchsia"   value="<%=form.format(new Date()) %>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                           <td class="">
                             <input type="text"  size="12" style="color:fuchsia"     value="<%=form.format(new Date()) %>" name="fecha2" class="inputText">
                ...
                <tr class="outputText3">
                        ...
                        <td class="">
                            ...
                            <select style="width:350px;color:blue" name="codTipoLote"  class="outputText3" >
                                <option value="0" >-TODOS-</option>
            ...
            <center>
                ...
                <input type="button" class="outputText2"  value="Ver Reporte Excel" name="reporte" onclick="verReporte(form1,'reporteResumenGeneralLotesExportarExcel.jsp')" />
                <input type="button" class="outputText2" onclick="limpiar(form1);"  value="Limpiar " name="reporteL" />
