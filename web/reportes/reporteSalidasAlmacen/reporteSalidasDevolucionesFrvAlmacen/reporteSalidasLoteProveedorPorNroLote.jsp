package reportes.reporteSalidasAlmacen.reporteSalidasAlmacenPorNroLote_1;
...
%>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px" cellpadding="0" cellspacing="0"  >
                ...
                <tr class="">
                    ...
                    <td>
                    <table  style="border : solid #D8D8D8 1px;width:100%;height:40px" class="border"  bgcolor="#f2f2f2" >
                        <tr><td style="width:50%">Lote Proveedor</td><td style="width:50%">Cantidad</td></tr>
                    </table>
                    </td>
                </tr>
                ...
                while (rs.next()) {
                    if(c==0){
                        ...
                        if(nroSalidaAux!=rs.getInt("NRO_SALIDA_ALMACEN")){
                                ...
                                out.print("<td style = 'width:500px;vertical-align:top' >");
                                consulta = " select i.LOTE_MATERIAL_PROVEEDOR,s.CANTIDAD,p.nombre_proveedor" +
                                        " from SALIDAS_ALMACEN_DETALLE_INGRESO s inner join INGRESOS_ALMACEN_DETALLE_ESTADO i on i.COD_INGRESO_ALMACEN = s.COD_INGRESO_ALMACEN" +
                                        " inner join ingresos_almacen_detalle iad on iad.cod_ingreso_almacen = i.cod_ingreso_almacen and iad.cod_material = i.cod_material" +
                                        ...
                                        " and i.ETIQUETA = s.ETIQUETA and i.COD_MATERIAL = s.COD_MATERIAL" +
                                        " where s.COD_SALIDA_ALMACEN = '"+rs.getInt("cod_salida_almacen")+"' and s.COD_MATERIAL = '"+rs.getInt("cod_material")+"'";
                                        System.out.println("consulta " + consulta);
                                        Statement st1 = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                                        ResultSet rs1 = st1.executeQuery(consulta);

                                        out.print("<table style='width:100%;vertical-align:top;height:40px' cellpadding='0' cellspacing='0'>");
                                        //rs1.last();
                                        //int filas = rs1.getRow();
                                        //rs1.first();
                                        
                                        while(rs1.next()){
                                            if(rs1.getDouble("cantidad")>0){
                                            out.print("<tr>");
                                            out.print("<td style='width:250px; border : solid #D8D8D8 1px;padding-left:5PX;'>"+(rs1.getString("nombre_proveedor")==null?"":rs1.getString("nombre_proveedor"))+"</td>");
                                            out.print("<td style='width:100px;border : solid #D8D8D8 1px;padding-left:5PX;'>"+(rs1.getString("lote_material_proveedor")==null?"":rs1.getString("lote_material_proveedor"))+"</td>");
                                            out.print("<td style='width:100px;border : solid #D8D8D8 1px;padding-left:5PX;'>"+rs1.getDouble("cantidad")+" "+(rs.getString("ABREVIATURA")==null?"":rs.getString("ABREVIATURA"))+"</td>");
                                            out.print("</tr>");
                                            }
                                        }
                                        out.print("</table>");
