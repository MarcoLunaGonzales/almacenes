...
package reportes.reporteSalidasAlmacen.reporteResumenSalidasAlmacenPorSeccion;
        ...
        <form>
            ...
            <table width="90%" align="center" class="outputText0" style="border : solid #000000 1px;" cellpadding="0" cellspacing="0" >
                ...
                <%
                        ...
                        consulta += " ) AS DEVOLUCIONES_CL_1,(select SUM(iad.CANT_TOTAL_INGRESO_FISICO * IAD.COSTO_UNITARIO_ACTUALIZADO)" +
                                ...
                                " inner join SALIDAS_ALMACEN s on s.COD_SALIDA_ALMACEN = d.COD_SALIDA_ALMACEN and s.COD_ALMACEN = d.COD_ALMACEN and s.COD_AREA_EMPRESA = ae.COD_AREA_EMPRESA" +
                                " where ia.FECHA_INGRESO_ALMACEN between '"+fechaInicial+" 00:00:00' and '"+fechaFinal+" 23:59:59'" +
                                " and ia.COD_ESTADO_INGRESO_ALMACEN = 1 and d.COD_ESTADO_DEVOLUCION = 1 and s.COD_LOTE_PRODUCCION <>''";
                        if(!codTipoSalidaArray.equals("") && !codTipoSalidaArray.equals("0")){
                        ...
                        consulta += ") as DEVOLUCIONES_CL, (SELECT SUM(SADI.CANTIDAD*SADI.COSTO_SALIDA_ACTUALIZADO)";
                        consulta += " FROM SALIDAS_ALMACEN_DETALLE_INGRESO SADI,SALIDAS_ALMACEN SA";
                        consulta += " WHERE  SA.COD_ESTADO_SALIDA_ALMACEN=1 AND SADI.COD_SALIDA_ALMACEN=SA.COD_SALIDA_ALMACEN AND SA.ESTADO_SISTEMA=1";
                        //consulta += " AND SA.COD_ALMACEN=1 " ;
                        if(!codAlmacen.equals("") && !codAlmacen.equals("0")){
                            consulta += " AND SA.COD_ALMACEN="+codAlmacen+" ";
                        }
                        if(!codTipoSalidaArray.equals("") && !codTipoSalidaArray.equals("0")){
