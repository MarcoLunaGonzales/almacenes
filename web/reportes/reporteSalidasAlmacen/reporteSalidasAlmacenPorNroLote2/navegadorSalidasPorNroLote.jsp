...
<html>
    <head>
        ...
        <script>
            ...
            function limpiar(f){
                //alert("t:"+f.codFilial.value);
                f.codFilial.value=0;
                f.codAlmacen.value=0;
                f.check.checked=false;
                f.fecha2.disabled=true;
                f.fecha1.disabled=true;
               // alert("tt:"+f.codFilial.value);
                f.action='navegadorSalidasPorNroLote.jsf'
                f.target='_self';
            }
    ...
    <body>
        ...
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
            <div align="center">
                <table border="0"  border="0" class="border" width="70%">
           ...
           //String codAlmacenF=request.getParameter("codAlmacen");
           //String codFilialF=request.getParameter("codFilial");
           ...
           //if(codAlmacenF.equals("0") && codFilialF.equals("0")){
              // codigoAlmacen=0;
           //}
            ...
            ResultSet rs = st.executeQuery(sql);
                    ...
                    <tr class="outputText3">
                        ...
                        %>
                            ...
                            <select style="width:350px;" name="codProducto"  class="outputText3" >
                                <option value="0" >-TODOS-</option>
                                <%
                            while (rs.next()) {
                       ...
                       <td  height="35px" class="">Nro de Lote</td>
                        <td class="">::</td>
                        <td class="">
                                <input type="text" style="color:blue;text-transform:uppercase"  class="inputText" size="20" name="numLote" />
                        </td>
        ...
        SimpleDateFormat form = new SimpleDateFormat("dd/MM/yyyy");
                        ...
                        <td class="">
                            ...
                            <input type="text" disabled="true"  size="12" style="color:fuchsia"   value="<%=form.format(new Date())%>" name="fecha1" class="inputText">
                        ...
                        <td class="">::</td>
                        <td class="">
                            <input type="text" disabled="true"  size="12" style="color:fuchsia"     value="<%=form.format(new Date())%>" name="fecha2" class="inputText">
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteSalidasPorNroLote.jsp')" />
                <input type="button" class="outputText2"  value="Ver Reporte Excel" name="reporte" onclick="verReporte(form1,'reporteSalidasPorNroLoteExcel.jsp')" />
	         <input type="button" class="outputText2"  value="Limpiar" onclick="limpiar(form1)" name="reporteL" />
