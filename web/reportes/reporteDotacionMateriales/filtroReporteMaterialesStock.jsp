...
<html>
          ...
          function ajaxAlmacen(f){
             ...
             function ajaxGrupo(f){
              ...
              function ajaxMaterial(f){
                ...
                var div_item;
                div_item=document.getElementById("divItem");
    ...
    <body>
        <h3 align="center">Reporte de Stock Materiales</h3>
        <form method="post" action="reporteExistenciasAlmacen.jsp" target="_blank" name="form1">
            <div align="center">
                <table border="0"  border="0" class="border" width="90%">
                    ...
                    <tr class="outputText3" >
                        ...
                        <td class="">
                            <div id="div_grupo">
                                <select name="codGrupo" class="inputText" multiple size="10" style="width:200px;" onchange="ajaxMaterial(form1);">
            ...
            <br>
            <center>
                <input type="button" class="outputText2"  value="Ver Reporte" name="reporte" onclick="verReporte(form1,'reporteMaterialesStock.jsp')" />
