                ...
                <table border="0"  border="0" style="border:1px solid maroon" class="border" cellpadding="2" width="80%">
                    ...
                    <tr class="outputText3">
                     ...
                     <tr class="outputText3">
                        ...
                        <tr >
                            <td colspan="9" style="text-align: center"><button onclick="buscarSalidas()" class="btn" >BUSCAR SALIDA</button></td>
                        </tr>
                        <tr>
                            <td  style="text-align:center" colspan="9" >
                                ...
                                <table cellpadding="0" class="tablaSalidas" >
                                    ...
                                    <%
                                    consulta="select sa.COD_SALIDA_ALMACEN,sa.NRO_SALIDA_ALMACEN,cp.nombre_prod_semiterminado,sa.COD_LOTE_PRODUCCION,sa.FECHA_SALIDA_ALMACEN"+
                                    ...
                                    while(res.next())
                                    {
                                        ...
                                        out.println("<td><a onclick='detallarSalida("+res.getInt("COD_SALIDA_ALMACEN")+",this)' href='#'><img src='../../img/detalle.img'/></a></td>");
                                        out.println("</tr>");
                                    }
                                    %>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center">
                                <button class="btn" onclick="generarEtiquetas()">IMPRIMIR</button>
                            </td>
                        </tr>
