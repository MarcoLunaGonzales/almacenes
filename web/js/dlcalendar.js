...
var dlcalendar_oCalendarDefaults =
{
	...
	navbar_style : "background-color: rgb(157, 90, 158);font-weigth:bold;font-size:14px !important",
	daybar_style : "background-color:#cfa5d0;font-family:arial; color:000000;",
	...
	use_webdings : false,
	nav_images : "/"+dominioSistemaDlCalendar+"/img/ant_anio.bmp,/"+dominioSistemaDlCalendar+"/img/ant_mes.bmp,/"+dominioSistemaDlCalendar+"/img/post_mes.bmp,/"+dominioSistemaDlCalendar+"/img/post_anio.bmp",
...
[
[ "#dlcalendar_container",         'width:12.5em; table-layout:fixed;' ],
[ '#dlcalendar_navigationRow',     'height:1.5em; width:100%; margin:0px; border:1px solid #006699; background-color:#006699; color:#ffffff; font-family:arial,helvetica,sans-serif; text-align:center;  cursor:default;' ],
...
[ '#dlcalendar_bodyTable',         'table-layout:fixed;cursor:default; width:100%; border:1px solid #006699; margin:0px; border-collapse:separate' ],

[ '#dlcalendar_headerRow',         'height:1.2em; text-align:center; vertical-align:middle; color:#000000; background-color:#006699; font-family:arial,helvetica,sans-serif; cursor:default;' ],
[ 'th.dlcalendar_headerRowCell',   'width:1.6em; padding:2px; font-size: .7em; text-align:center; color:#ffffff' ],

[ 'tr.dlcalendar_dateRow',         'height:1.2em; text-align:center; vertical-align:middle;' ],

[ 'td.dlcalendar_dayRegular',      'text-align:center;font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #cccccc; color:#000000; background-color:#f2f2f2; cursor:pointer' ],
[ 'td.dlcalendar_dayWeekend',      'text-align:center;font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #cccccc; color:#990000; background-color:#f2f2f2; cursor:pointer' ],
[ 'td.dlcalendar_daySelected',     'font-family:arial,helvetica,sans-serif; font-size:.8em;font-weight:bold; width:1em; padding:1px; border:1px solid #000000; color:#ffffff; background-color:#757575; cursor:default' ],
[ 'td.dlcalendar_dayOtherMonth',   'font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #ffffff; color:#ffffff; background-color:#ffffff; cursor:default' ],
[ 'td.dlcalendar_dayDisabled',     'font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #ffffff; color:#cccccc; background-color:#ffffff; cursor:default' ]
];
var arrayDlCalendar = new Array();
...
function dlcalendar_parseCalendarTags()
{
    ...
    var calendar = document.getElementsByClassName('dlCalendar');
	for( var i =0; i <calendar.length ; i++)
	{
		var oCalendarParams = new Object();
		var imagen =document.createElement("img");
		var idImagenCalendar = calendar[i].id+ "DlCalendar";
		imagen.src = "/"+dominioSistemaDlCalendar+"/img/fecha.bmp";
		imagen.id = idImagenCalendar
		calendar[i].parentNode.appendChild(imagen);
		oCalendarParams[ 'click_element_id' ] = idImagenCalendar;
		oCalendarParams[ 'input_element_id' ] = calendar[i].id;
		oCalendarParams[ 'tool_tip' ] = 'Seleccione la Fecha';
		oCalendarParams['daybar_style'] = 'background-color: DBE1E7';
        oCalendarParams['navbar_style'] = 'background-color: 7992B7; color:ffffff';
		dlcalendar_makeCalendar(oCalendarParams);
	}
...
function dlcalendar_ByClass(idInput,textToolTip)
{
	var oCalendarParams = new Object();
...
function dlcalendar_getInputElement()
{
	...
	return dlcalendar_getElementById(this.input_element_id.toString());
}
