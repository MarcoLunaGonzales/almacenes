        ...
        <body >
            ...
            <a4j:form id="form1">
                <div align="center">
                    ...
                    <h3 align="center">Salidas de Almacen por Orden de Trabajo</h3>
                    ...
                    <rich:dataTable value="#{ManagedSeguimientoSolicitudMantenimiento.solicitudMantenimientoList}"
                        ...
                        <rich:column>
                            ...
                            <h:selectBooleanCheckbox value="#{data.checked}"/><%-- rendered="#{data.estadoSolicitudMantenimiento.codEstadoSolicitudMantenimiento!=4}" --%>
                        </rich:column>
                        ...
                        <rich:column>
                            ...
                            <h:outputText  rendered="#{data.solicitudProyecto eq '1'}" value=" PROY"  />
                            <h:outputText  rendered="#{data.solicitudProduccion eq '1'}" value=" PROD"  />
                        </rich:column >
                        <rich:column>
                            <f:facet name="header">
                       ...
                       <rich:column>
                        ...
                        <%--rich:column>
                            ...
                            <h:outputText value="#{data.solicitudesCompra.codSolicitudCompra==0}"  >
                    ...
                    <a4j:commandButton value="Generar Salida de Materiales"   styleClass="btn"
                    action="#{ManagedSeguimientoSolicitudMantenimiento.solicitudMateriales_action}"
            ...
            <rich:modalPanel id="panelBuscarSolicitudMantenimiento"  minHeight="300"  minWidth="1000"
                        ...
                        <h:panelGroup id="contenidoBuscarSolicitudMantenimiento">
                            <h:panelGrid columns="4">
                                ...
                                <h:inputText value="#{ManagedSeguimientoSolicitudMantenimiento.solicitudMantenimientoBean.codSolicitudMantenimiento}" styleClass="inputText" size="5" onkeypress="valNum(event);" /--%>
                                <h:outputText value="Nro O.T.:" styleClass="outputText1" />
                                <h:inputText value="#{ManagedSeguimientoSolicitudMantenimiento.solicitudMantenimientoBean.nroOrdenTrabajo}" styleClass="inputText" size="5" onkeypress="valNum(event);" />
                                ...
                                <h:selectOneMenu value="#{ManagedSeguimientoSolicitudMantenimiento.solicitudMantenimientoBean.maquinaria.codMaquina}" styleClass="inputText" style="width:280px">
