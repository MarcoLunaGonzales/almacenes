...
<f:view>
    <html>
        ...
        <body  >
            <br>
<div align="center" style=" position:absolute; filter:alpha(opacity=50); opacity:0.5;width:100%;height:100%;background-position:center; background-attachment:fixed;background-repeat:no-repeat; background-image:url(img/fondo_imagen_baco.jpg);" >
    </div>
    <%
    try
      {
